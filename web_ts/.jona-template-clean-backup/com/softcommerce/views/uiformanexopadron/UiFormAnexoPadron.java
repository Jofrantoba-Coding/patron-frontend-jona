...
public class UiFormAnexoPadron extends JDialog implements InterUiFormAnexoPadron, ActionListener {
    ...
    protected JComboBox cbo_Padron;
    ...
    protected int id_tipo_anexo;
    protected AnexoPadronTableModel modelAnexoPadron;
    ...
    protected void loadPadron() {
    }

    protected boolean verificarPadron() {
        return false;
    }
