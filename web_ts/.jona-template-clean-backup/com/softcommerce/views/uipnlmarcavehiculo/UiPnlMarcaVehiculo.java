 ...
 */
package com.softcommerce.views.uipnlmarcavehiculo;
 ...
 */
public class UiPnlMarcaVehiculo extends JHInternalFrame implements InterUiPnlMarcaVehiculo, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public UiPnlMarcaVehiculo(String title, JFrame frame, Usuario usuario) {
    ...
    public UiPnlMarcaVehiculo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
