...
public class UiCambiarCondicionPago extends CDialog implements InterUiCambiarCondicionPago, ActionListener, KeyListener, FocusListener, WindowFocusListener, WindowListener, ItemListener, MouseListener, PropertyChangeListener {
    ...
    protected JComboBox cbMoneda;
    protected List<BeanMoneda> xmoneda;
    protected JComboBox cboDiasPago;
    protected List<BeanCondicionPago> xcondpago;
    protected JComboBox cboMedioPago;
    protected List<BeanTipoPago> xmediopago;
    protected JComboBox cboCondicionPago;
    protected JComboBox cboCancelaEn;
    protected JButton cbCancelar;
    protected JButton cbGuardar;
    protected JTextField txt_tipooperacion;
    protected JTextField txt_tipocambio;
    protected JTextField txt_idregconta;
    protected JTextField txt_documento;
