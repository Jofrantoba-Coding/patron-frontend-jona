...
public class UiPnlCotizacionAddItem 
    ...
    protected Gif gif;
    protected List<BeanCotizacionDet> listDetalle;
    protected List<BeanPedidoDet> listDetallePedido;
    protected JHDialog argPadre;
    ...
    protected boolean existeItem(String id_item, String id_almacen) throws Exception {
        return false;
    }
