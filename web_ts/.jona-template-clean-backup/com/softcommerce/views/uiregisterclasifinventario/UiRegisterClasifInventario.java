...
package com.softcommerce.views.uiregisterclasifinventario;
...
public class UiRegisterClasifInventario extends AbstractRegister implements InterUiRegisterClasifInventario, ActionListener, ItemListener, KeyListener,FocusListener
{
    protected JTextField txt_Codigo;
    protected JTextField txt_Descripcion;
    protected JTextField txt_Abrev;

    protected CRadioButton rb_TipoMovInvEntrada;
    protected CRadioButton rb_TipoMovInvSalida;
    protected CRadioButton rb_TipoMovInvNinguno;
    protected ButtonGroup bg_TipoMovInv;
    ...
    public UiRegisterClasifInventario(Frame arg0,Usuario usuario)
    {
        super(arg0);
    ...
    public UiRegisterClasifInventario(Dialog arg0,Usuario usuario)
    {
        super(arg0);
        this.usuario = usuario;
	inicialize();
