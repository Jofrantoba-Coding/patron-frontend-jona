...
public class UiPanelTFItem
    ...
    protected JTextField txtClienteItemColor;
    ...
    protected final Main frame;
    protected Date fechaInicio;
    protected Date fechaFin;
    protected JCheckBox chkIncluyePercepcion;
    protected JCheckBox chkNoIncluyePercepcion;
    protected JCheckBox chkTieneHijos;
    protected final Logger logger = Logger.getLogger(UiPanelTFItem.class);
    ...
    protected JHDialog getRegister() {
    ...
    protected List<BeanItem> getListItem() throws Exception {
        return null;
    }
