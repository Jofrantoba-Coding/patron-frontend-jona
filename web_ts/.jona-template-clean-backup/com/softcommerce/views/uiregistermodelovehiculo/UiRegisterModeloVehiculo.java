 ...
 */
package com.softcommerce.views.uiregistermodelovehiculo;
 ...
 */
public class UiRegisterModeloVehiculo extends JHDialog implements InterUiRegisterModeloVehiculo, ActionListener, ItemListener, KeyListener, FocusListener {

    protected Usuario usuario;
    protected JTextField txt_Codigo;
    protected JTextField txt_Descripcion;
    protected JCheckBox chkEstado;
    protected BeanModeloVehiculo beanModeloVehiculo;

    public UiRegisterModeloVehiculo(Frame arg0, Usuario usuario, BeanModeloVehiculo wModeloVehiculo) {
        super(arg0, true);
