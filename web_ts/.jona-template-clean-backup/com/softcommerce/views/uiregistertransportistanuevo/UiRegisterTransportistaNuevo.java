...
public class UiRegisterTransportistaNuevo
        extends JHDialog
        implements InterUiRegisterTransportistaNuevo, ActionListener, ItemListener, KeyListener, WindowListener, MouseListener, FocusListener, TableModelListener, ListSelectionListener {
    ...
    protected List<BeanVehiculo> listVehiculo;
    protected final Logger logger = Logger.getLogger(UiRegisterTransportistaNuevo.class);

    public UiRegisterTransportistaNuevo(Frame arg0, Usuario usuario) {
        super(arg0, true);
    ...
    public UiRegisterTransportistaNuevo(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
    ...
    protected JPanel getPanelVehiculo() {
        JPanel pnlActivacion = new JPanel(new BorderLayout());
        pnlActivacion.setLayout(new BorderLayout(0, 0));
        pnlActivacion.setBackground(new Color(245, 245, 245));
        /*JToolBar toolbar = new JToolBar();
    ...
    protected String getXmlVehiculo() {
        String xmlVehiculo = "";
    ...
    protected void quitarVehiculo(String id_vehiculo) {
    }
