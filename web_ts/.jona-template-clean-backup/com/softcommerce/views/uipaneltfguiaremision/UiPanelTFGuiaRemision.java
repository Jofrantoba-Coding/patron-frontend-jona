...
public class UiPanelTFGuiaRemision
        extends JHInternalFrame
        implements InterUiPanelTFGuiaRemision, ListSelectionListener, FocusListener, KeyListener, ActionListener, PropertyChangeListener {

    protected JTextField txtGuiaSerie;
    protected JTextField txtGuiareimpreso;
    protected JTextField txtDocumentoventaidtipodoc;
    protected JTextField txtDocumentoventaserie;
    protected JTextField txtDocumentoventapreimpreso;
    ...
    protected List<MotivoTraslado> xmotivo;
    protected JComboBox cboIdmotivo;
    public CTable table;
    ...
    protected RegisterGuiaRemision registeri;
    protected Date fechaInicio;
    protected Date fechaFin;
    protected JDateChooser dcFechainicio;
    protected JDateChooser dcFechafin;
    protected CuadroMensaje cuadro = null;
    protected final Logger logger = Logger.getLogger(UiPanelTFGuiaRemision.class);

    public UiPanelTFGuiaRemision(String title, JFrame frame, JDesktopPane jdp, Usuario usuario) {
        super(title + " - UiPanelTFGuiaRemision");
    ...
    public UiPanelTFGuiaRemision(String title, JFrame frame, JDesktopPane jdp, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public UiPanelTFGuiaRemision(String title, JFrame frame, JDesktopPane jdp, Usuario usuario, boolean vendedor) {
        super(title + " - UiPanelTFGuiaRemision", true, false, false, true, false, true, true, true, true, true, true, true, true);
        this.usuario = usuario;
        this.frame = frame;
        this.jdp = jdp;
        inicialize();
