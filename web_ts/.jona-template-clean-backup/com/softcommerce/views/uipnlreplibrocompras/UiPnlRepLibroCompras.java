...
public class UiPnlRepLibroCompras 
    ...
    protected Gif gif;
    protected JTable tblTipoDoc;
    protected TableModelTipoDoc modelTipoDoc;
    protected CheckBoxHeader checkHeader;
    protected JCheckBox chkConsolidadoTicket;
    protected final Logger logger = Logger.getLogger(UiPnlRepLibroCompras.class);
    ...
    protected JScrollPane getPnlCenter() {
    ...
    protected void loadDocumentos() {
    }

    protected JPanel getPnlNorte() {
    ...
    protected JRBeanCollectionDataSource getDataSourceCompras(String mesIni, String mesFin) throws Exception {
        try {
    ...
    protected JRDataSource getDataSourceVenta(String mesIni, String mesFin) throws Exception {
        try {
    ...
    protected List<BeanRptVenta> getListaVenta(String mesIni, String mesFin) throws Exception {
        return null;
    }

    protected List getListaCompra(String mesIni, String mesFin) throws Exception {
        return null;
    }
