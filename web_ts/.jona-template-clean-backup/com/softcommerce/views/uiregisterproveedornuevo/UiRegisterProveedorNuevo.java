 ...
 */
package com.softcommerce.views.uiregisterproveedornuevo;
 ...
 */
public class UiRegisterProveedorNuevo
        extends JHDialog
        implements InterUiRegisterProveedorNuevo, ActionListener, ItemListener, KeyListener, WindowListener, MouseListener, FocusListener, TableModelListener, ListSelectionListener {
    ...
    protected JCheckBox chk_buen_contrib;
    protected JCheckBox chkEstado;
    //Activacion de Proveedor
    protected JButton btn_ActivarProveedor;
    protected JButton btn_DesactivarProveedor;
    ...
    protected JButton btn_ActivarPadron;
    protected JButton btn_DesactivarPadron;
    protected CTable tableProveedorPadron;
    public AnexoPadronTableModel modeltableProveedorPadron;
    protected TableRowSorter modeloOrdenadoProveedorPadron;
    protected JScrollPane scrollProveedorPadron;
    protected final Logger logger = Logger.getLogger(UiRegisterProveedorNuevo.class);

    public UiRegisterProveedorNuevo(Frame arg0, Usuario usuario) {
        super(arg0, true);
    ...
    public UiRegisterProveedorNuevo(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
    ...
    protected BeanProveedor llenarBeanProveedor() {
