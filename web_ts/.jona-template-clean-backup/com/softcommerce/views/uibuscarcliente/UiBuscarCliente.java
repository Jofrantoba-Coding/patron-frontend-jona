...
public class UiBuscarCliente extends JDialog implements InterUiBuscarCliente, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener {
    
    protected CDialog ard;
    protected JHDialog dialog;
    protected JHInternalDialog ari;
    protected JHDialog ar3;
    protected Component comp;
    protected int indiceTabla;
    protected JTabbedPane tabSearch;
    protected AnexoTableModel modeltblSearch;
    ...
    protected List<Anexo> xclasificacion;
    ...
    protected JHInternal ar33;
    protected Object argIntFrame;
    protected Anexo an;
    protected java.net.URL path;
    protected String strForm;
    
    public UiBuscarCliente(CDialog arg1, java.net.URL path) {
        super(arg1);
        this.path = path;
        this.ard = arg1;
        initialize();
    ...
    public UiBuscarCliente(Frame arg0, CDialog arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ard = arg1;
        initialize();
    ...
    public UiBuscarCliente(Dialog arg0, JHDialog arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ar3 = arg1;
        initialize();
    ...
    public UiBuscarCliente(JFrame arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ar33 = arg1;
        initialize();
    ...
    public UiBuscarCliente(JFrame arg0, Object arg1, java.net.URL path, String wForm) {
        super(arg0);
        this.path = path;
    ...
    public UiBuscarCliente(Dialog arg0, CDialog arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ard = arg1;
        initialize();
    ...
    public UiBuscarCliente(JHDialog arg0, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.dialog = arg0;
        initialize();
    ...
    public UiBuscarCliente(Frame arg0, JHInternalDialog arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ari = arg1;
        initialize();
    ...
    protected void filtrarTabla(JTable tabla, AnexoTableModel model) {
    }
