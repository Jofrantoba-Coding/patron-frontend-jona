...
package com.softcommerce.views.uiregistermotivotraslado;
...
public class UiRegisterMotivoTraslado extends JHDialog implements InterUiRegisterMotivoTraslado, ActionListener, ItemListener, KeyListener, FocusListener
{
    protected JTextField txt_Codigo;
    protected JTextField txt_Descripcion;
    protected JTextField txt_abrev;

    protected JCheckBox chk_habguia;
    
    protected Usuario usuario;

    public UiRegisterMotivoTraslado(Frame arg0,Usuario usuario)
    {
        super(arg0);
    ...
    public UiRegisterMotivoTraslado(Dialog arg0,Usuario usuario)
    {
        super(arg0);
        this.usuario = usuario;
	inicialize();
