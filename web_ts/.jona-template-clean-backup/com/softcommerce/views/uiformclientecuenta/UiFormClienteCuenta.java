 ...
 */
package com.softcommerce.views.uiformclientecuenta;
 ...
 */
public class UiFormClienteCuenta extends JDialog implements InterUiFormClienteCuenta, ActionListener{
    ...
    protected JPanel pnlAccion;
    protected JButton btnProccess;
    protected JComboBox cbo_Banco;
    protected List<TablaDetalleSunat> xBanco;
    protected JTextField txtDescripcion;
    protected JTextField txtNumCuenta;
    
    public UiFormClienteCuenta(JHDialog arg0,java.net.URL path,Component comp){
        super(arg0);
        this.dialog=arg0;
        this.comp=comp;
        this.path=path;
