package com.softcommerce.views.uibuscarncentregadodetallecliente;
...
public class UiBuscarNCEntregadoDetalleCliente extends CDialog implements InterUiBuscarNCEntregadoDetalleCliente, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {

    private static final long serialVersionUID = 1L;
    protected Component comp;
    protected IngresoDevolucionClienteTableModel modeltable;
    ...
    public UiBuscarNCEntregadoDetalleCliente(Frame arg0, JHInternal pnlguia, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = pnlguia;
    ...
    protected void initialize() {
        ...
        setTitle("Buscar Documento de Venta - UiBuscarNCEntregadoDetalleCliente");
        setContentPane(pnl);
        setModal(true);
        setResizable(false);
        setSize(880, 440);
