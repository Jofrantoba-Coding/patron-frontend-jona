 ...
 * @author TOSHIBA
 */
public class UiPanelTFTipoCambio extends JHInternalFrame implements InterUiPanelTFTipoCambio, View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener, MouseListener, PropertyChangeListener {
    ...
    public UiPanelTFTipoCambio(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public UiPanelTFTipoCambio(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
