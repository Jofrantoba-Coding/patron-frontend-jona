 ...
 */
package com.softcommerce.views.uibuscarncdocumentosventa;
...
public class UiBuscarNCDocumentosVenta 
        extends CDialog implements InterUiBuscarNCDocumentosVenta, ActionListener, KeyListener, WindowListener, FocusListener {
    ...
    public UiBuscarNCDocumentosVenta(Frame arg0, JHInternal arg, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = arg;
    ...
    public void cargarTabla() {
        ...
        mdl_documento.agregarVectorMovInventarioCab(regla.listarBuscarNCDocumentosVenta(m));
        tbl_documento.setAllColumnPreferredWidth();
    }
    ...
    public void obtenerDatos() {
        ...
        PanelDiferenciaPrecio pnl = new PanelDiferenciaPrecio(frame, arg, usuario, path);
        if (row >= 0) {
            if (pnl != null) {
                pnl.setValueSearch(tbl_documento.getValueAt(row, 0).toString().trim(), comp);
            }
            dispose();
            pnl.cargarTabla(comp);
        }
    }
