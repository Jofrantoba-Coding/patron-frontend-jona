 ...
 */
package com.softcommerce.views.uipaneltfcierreaperturacaja;


import com.softcommerce.formularios.*;
import com.softcommerce.beans.Usuario;
import com.softcommerce.formularios.RegisterCierreAperturaCaja;
...
import com.softcommerce.general.tablas.CierreAperturaCajaTableModel;
 ...
 * @author TOSHIBA
 */
public class UiPanelTFCierreAperturaCaja extends JHInternalFrame implements InterUiPanelTFCierreAperturaCaja, View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {

    public CTable table;
    public CierreAperturaCajaTableModel modeltable;
    ...
    public UiPanelTFCierreAperturaCaja(String title, JFrame frm, Usuario usuario) {
        super(title);
        this.frame = frm;
    ...
    public UiPanelTFCierreAperturaCaja(String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        ...
        modeltable = new CierreAperturaCajaTableModel();
    ...
    public void cargarTabla() {
        ...
        modeltable.agregarVectorcierrecaja(regla.listarGeneral());
        table.setAllColumnPreferredWidth();
        refresh();
    }
    ...
    public void controlAdd() {
        RegisterCierreAperturaCaja reg = new RegisterCierreAperturaCaja(frame, usuario, this);
        reg.setPath(path);
        reg.setModeRegister(Register.INSERT);
        reg.setVisible(true);
    }
    ...
    public void controlModify() {
        ...
        RegisterCierreAperturaCaja reg = new RegisterCierreAperturaCaja(frame, usuario, this);
        reg.setPath(path);
        if (reg.setModeRegister(Register.UPDATE)) {
            reg.setVisible(true);
        } else {
            reg.dispose();
            controlRefresh();
    ...
    public void controlEliminate() {
        ...
        RegisterCierreAperturaCaja reg = new RegisterCierreAperturaCaja(frame, usuario, this);
        reg.setPath(path);
        if (reg.setModeRegister(Register.DELETE)) {
            reg.setVisible(true);
        } else {
            reg.dispose();
            controlRefresh();
    ...
    public void controlDetails() {
        ...
        RegisterCierreAperturaCaja reg = new RegisterCierreAperturaCaja(frame, usuario, this);
        reg.setPath(path);
        if (reg.setModeRegister(Register.DETAIL)) {
            reg.setVisible(true);
        } else {
            reg.dispose();
            controlRefresh();
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Cierre Apertura Caja");
