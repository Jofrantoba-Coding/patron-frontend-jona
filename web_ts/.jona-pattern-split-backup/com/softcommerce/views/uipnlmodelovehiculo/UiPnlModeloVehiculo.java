 ...
 */
package com.softcommerce.views.uipnlmodelovehiculo;


import com.softcommerce.formularios.*;
import com.softcommerce.beans.BeanModeloVehiculo;
import com.softcommerce.beans.Usuario;
import com.softcommerce.general.tablas.ModeloVehiculoTableModel;
 ...
 */
public class UiPnlModeloVehiculo extends JHInternalFrame implements InterUiPnlModeloVehiculo, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    public CTable table;
    public ModeloVehiculoTableModel modeltable;
    ...
    public UiPnlModeloVehiculo(String title, JFrame frame, Usuario usuario) {
    ...
    public UiPnlModeloVehiculo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new ModeloVehiculoTableModel();
    ...
    public void cargarTabla() {
        try {
            RnModeloVehiculo regla = new RnModeloVehiculo(path);
            modeloOrdenado.setRowFilter(null);
            modeltable.clearTable();
            List<BeanModeloVehiculo> lista = regla.listarModeloVehiculo("", "");
            modeltable.agregarListModeloVehiculo(lista);
    ...
    public void controlAdd() {
        ...
        try {
            RegisterModeloVehiculo register = new RegisterModeloVehiculo(frame, usuario, null);
    ...
    public void controlModify() {
        ...
        BeanModeloVehiculo beanCuenta = modeltable.getModeloVehiculo(realRowIndex);
        setCursor(new Cursor(Cursor.WAIT_CURSOR));
        RegisterModeloVehiculo register = new RegisterModeloVehiculo(frame, usuario, beanCuenta);
        register.setPath(path);
        register.setRowSelection(this);
        register.setView(this);
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Modelo Vehículo");
