...
public class UiRegisterVentaResumenImpl extends UiRegisterVentaResumen {

    public UiRegisterVentaResumenImpl(Main frm, String title, Usuario usuario, URL path) {
