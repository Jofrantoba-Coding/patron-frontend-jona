 ...
 */
package com.softcommerce.views.uipaneltftipoanexo;
...
import com.softcommerce.formularios.RegisterTipoAnexo;
...
import com.softcommerce.general.tablas.TipoAnexoTableModel;
 ...
 * @author TOSHIBA
 */
public class UiPanelTFTipoAnexo extends JHInternalFrame implements InterUiPanelTFTipoAnexo, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    public CTable table;
    public TipoAnexoTableModel modeltable;
    ...
    public UiPanelTFTipoAnexo(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    private void inicialize() {
        modeltable = new TipoAnexoTableModel();
    ...
    public void controlAdd() {
        ...
        RegisterTipoAnexo register = new RegisterTipoAnexo(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectorTipoAnexo(regla.listar(""));
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception ex) {
