...
public class UiRegisterPedidoImpl extends UiRegisterPedido {

    public UiRegisterPedidoImpl(Main frm, String title, Usuario usuario, java.net.URL path, Date fechaInicio, Date fechaFin) {
        super(frm, title, usuario, path, fechaInicio, fechaFin);
    }
}
