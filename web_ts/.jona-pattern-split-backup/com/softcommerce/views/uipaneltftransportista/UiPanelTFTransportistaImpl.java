...
public class UiPanelTFTransportistaImpl extends UiPanelTFTransportista {

    public UiPanelTFTransportistaImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFTransportistaImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
        super(title, frame, usuario, vPermiso);
    }

    public UiPanelTFTransportistaImpl(String title, JFrame frame, Usuario usuario, boolean vendedor) {
