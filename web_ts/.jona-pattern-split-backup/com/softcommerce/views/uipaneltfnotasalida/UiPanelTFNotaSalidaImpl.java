...
public class UiPanelTFNotaSalidaImpl extends UiPanelTFNotaSalida {

    public UiPanelTFNotaSalidaImpl(String title, Main frame, JDesktopPane jdp, Usuario usuario) {
        super(title, frame, jdp, usuario);
    }

    public UiPanelTFNotaSalidaImpl(String title, Main frame, JDesktopPane jdp, Usuario usuario, List<Boolean> vPermiso) {
