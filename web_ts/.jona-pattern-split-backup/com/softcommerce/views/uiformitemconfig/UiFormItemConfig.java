 ...
 */
public class UiFormItemConfig extends JDialog implements InterUiFormItemConfig, ActionListener {
    ...
    public UiFormItemConfig(JHDialog arg0, java.net.URL path, Component comp) {
        super(arg0);
        this.dialog = arg0;
        this.path = path;
        this.comp = comp;
