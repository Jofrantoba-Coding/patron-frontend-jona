...
public class UiPanelTFAduanaImpl extends UiPanelTFAduana {

    public UiPanelTFAduanaImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(areg, title, frm, usuario);
    }

    public UiPanelTFAduanaImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
