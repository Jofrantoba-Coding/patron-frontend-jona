...
public class UiFormConversionVarios
    ...
    private final Logger logger = Logger.getLogger(UiFormConversionVarios.class);
    ...
    private final UiRegisterIngreso UiRegisterIngreso;
    ...
    private void guardarConversion() throws Exception {
        ...
        this.UiRegisterIngreso.dispose();
    }
