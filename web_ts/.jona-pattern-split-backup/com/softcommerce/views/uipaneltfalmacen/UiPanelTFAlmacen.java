...
public class UiPanelTFAlmacen
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Lista de Almacenes");
    ...
    public void controlAdd() {
        ...
        RegisterAlmacen register = new RegisterAlmacen(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectoralmacen(regla.listar("", usuario.getCodempresa(), ""));
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
