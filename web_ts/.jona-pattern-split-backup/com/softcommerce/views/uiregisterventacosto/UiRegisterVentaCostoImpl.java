...
public class UiRegisterVentaCostoImpl extends UiRegisterVentaCosto {

    public UiRegisterVentaCostoImpl(Main frm, String title, Usuario usuario, java.net.URL path) {
