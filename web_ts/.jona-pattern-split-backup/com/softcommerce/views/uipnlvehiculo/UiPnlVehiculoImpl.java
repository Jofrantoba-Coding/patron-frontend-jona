...
public class UiPnlVehiculoImpl extends UiPnlVehiculo {

    public UiPnlVehiculoImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPnlVehiculoImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
