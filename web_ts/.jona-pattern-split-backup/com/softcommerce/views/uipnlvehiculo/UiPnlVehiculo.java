 ...
 */
package com.softcommerce.views.uipnlvehiculo;
 ...
 */
public class UiPnlVehiculo extends JHInternalFrame implements InterUiPnlVehiculo, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    private CTable table;
    private VehiculoTableModel modeltable;
    ...
    public UiPnlVehiculo(String title, JFrame frame, Usuario usuario) {
    ...
    public UiPnlVehiculo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new VehiculoTableModel();
    ...
    public void cargarTabla() {
        try {
            ...
            List<BeanVehiculo> lista = regla.listarVehiculo("", "", "");
            modeltable.agregarVectorVehiculo(lista);
    ...
    public void controlAdd() {
        ...
        try {
            RegisterVehiculo register = new RegisterVehiculo(frame, usuario, null);
    ...
    public void controlModify() {
        ...
        BeanVehiculo beanCuenta = modeltable.getVehiculo(realRowIndex);
        setCursor(new Cursor(Cursor.WAIT_CURSOR));
        RegisterVehiculo register = new RegisterVehiculo(frame, usuario, beanCuenta);
        register.setPath(path);
        register.setRowSelection(this);
        register.setView(this);
