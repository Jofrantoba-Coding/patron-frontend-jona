 ...
 */
public class UiPnlTipoTrabajador extends JHInternalFrame implements InterUiPnlTipoTrabajador, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    private CTable table;
    private TipoTrabajadorTableModel modeltable;
    ...
    public UiPnlTipoTrabajador(String title, JFrame frame, Usuario usuario) {
    ...
    public UiPnlTipoTrabajador(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new TipoTrabajadorTableModel();
        ...
        this.table.getColumnModel().getColumn(4).setCellRenderer(new CellRender());
    ...
    public void cargarTabla() {
        try {
            RnTipoTrabajador regla = new RnTipoTrabajador(path);
            modeloOrdenado.setRowFilter(null);
            modeltable.clearTable();
            List<BeanTipoTrabajador> lista = regla.listarTipoTrabajador("", "");
            modeltable.agregarListTipoTrabajador(lista);
    ...
    public void controlAdd() {
        ...
        try {
            RegisterTipoTrabajador register = new RegisterTipoTrabajador(frame, usuario, null);
    ...
    public void controlModify() {
        ...
        BeanTipoTrabajador beanCuenta = modeltable.getTipoTrabajador(realRowIndex);
        setCursor(new Cursor(Cursor.WAIT_CURSOR));
        RegisterTipoTrabajador register = new RegisterTipoTrabajador(frame, usuario, beanCuenta);
        register.setPath(path);
        register.setRowSelection(this);
        register.setView(this);
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Tipo Trabajador");
