...
public class UiPnlCotizacionImpl extends UiPnlCotizacion {

    public UiPnlCotizacionImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPnlCotizacionImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
