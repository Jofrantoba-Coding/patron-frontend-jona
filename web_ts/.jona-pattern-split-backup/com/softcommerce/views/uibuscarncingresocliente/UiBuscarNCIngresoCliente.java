 ...
 */
package com.softcommerce.views.uibuscarncingresocliente;
...
public class UiBuscarNCIngresoCliente extends CDialog implements InterUiBuscarNCIngresoCliente, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {

    private JTabbedPane tabb_documento;
    private IngresoTableModel mdl_documento;
    ...
    public UiBuscarNCIngresoCliente(Frame arg0, JHInternal arg, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = arg;
    ...
    private void initialize() {
        ...
        mdl_documento = new IngresoTableModel();
        ...
        tbl_documento.setNoVisibleColumn(0);
        tbl_documento.setNoVisibleColumn(2);
        tbl_documento.setNoVisibleColumn(3);
        tbl_documento.setNoVisibleColumn(4);
        tbl_documento.setNoVisibleColumn(5);
        tbl_documento.setNoVisibleColumn(6);
        tbl_documento.setNoVisibleColumn(7);
        ...
        tbl_documento.setNoVisibleColumn(12);
        tbl_documento.setNoVisibleColumn(13);
        tbl_documento.setNoVisibleColumn(14);
        tbl_documento.setNoVisibleColumn(15);
        tbl_documento.setNoVisibleColumn(16);
        tbl_documento.setNoVisibleColumn(17);
        tbl_documento.setNoVisibleColumn(18);
        tbl_documento.setNoVisibleColumn(19);
        tbl_documento.setNoVisibleColumn(20);
        tbl_documento.setNoVisibleColumn(21);
        tbl_documento.setNoVisibleColumn(22);
        tbl_documento.setNoVisibleColumn(23);
        tbl_documento.setNoVisibleColumn(24);
        tbl_documento.setNoVisibleColumn(25);
        tbl_documento.setNoVisibleColumn(26);
        tbl_documento.setNoVisibleColumn(27);
        tbl_documento.setNoVisibleColumn(28);
        tbl_documento.setNoVisibleColumn(32);
        tbl_documento.setNoVisibleColumn(33);
        tbl_documento.setNoVisibleColumn(34);
        tbl_documento.setNoVisibleColumn(35);
        tbl_documento.setNoVisibleColumn(36);
        tbl_documento.setNoVisibleColumn(37);
        tbl_documento.setNoVisibleColumn(38);
        tbl_documento.setNoVisibleColumn(39);
        tbl_documento.setNoVisibleColumn(40);
        tbl_documento.setNoVisibleColumn(41);
        tbl_documento.setNoVisibleColumn(42);
        tbl_documento.setNoVisibleColumn(43);
        tbl_documento.setNoVisibleColumn(44);
        tbl_documento.setNoVisibleColumn(45);
        tbl_documento.setNoVisibleColumn(46);
        tbl_documento.setNoVisibleColumn(47);
        tbl_documento.setNoVisibleColumn(48);
        tbl_documento.setNoVisibleColumn(49);
        tbl_documento.setNoVisibleColumn(52);
        tbl_documento.setNoVisibleColumn(53);
        tbl_documento.setNoVisibleColumn(55);
        tbl_documento.setNoVisibleColumn(56);
        tbl_documento.setNoVisibleColumn(57);
        tbl_documento.setNoVisibleColumn(58);
        tbl_documento.moveColumn(4, 2);
        tbl_documento.moveColumn(6, 3);
        tbl_documento.moveColumn(6, 4);
        ...
        //setTitle("Buscar Documentos de Venta con Entrega de Productos Realizado");
        setTitle("Buscar Notas de Ingreso de Productos entregados");
    ...
    public void cargarTabla() {
        ...
        m.setIdTipoDoc("NI");
        m.setIdTipoMov("006");
        m.setTieneCantPorgenerarNc("SI");

        RnRegContaCab regla = new RnRegContaCab(path);
        mdl_documento.clearTable();
        mdl_documento.agregarVectoringreso(regla.listarOrdenRecojo(m));
        tbl_documento.setAllColumnPreferredWidth();
    }
