...
public class UiPanelTFZonaImpl extends UiPanelTFZona {

    public UiPanelTFZonaImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFZonaImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
