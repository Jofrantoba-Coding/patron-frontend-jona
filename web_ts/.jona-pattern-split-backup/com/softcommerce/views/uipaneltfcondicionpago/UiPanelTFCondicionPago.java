 ...
 * @author TOSHIBA
 */
public class UiPanelTFCondicionPago extends JHInternalFrame implements InterUiPanelTFCondicionPago, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    private static final long serialVersionUID = 1L;
    public CTable table;
    public CondicionPagoTableModel modeltable;
    public TableRowSorter<CondicionPagoTableModel> modeloOrdenado;
    ...
    public UiPanelTFCondicionPago(String title, JFrame frame, Usuario usuario) {
        super(title);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    public UiPanelTFCondicionPago(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new CondicionPagoTableModel();
        modeloOrdenado = new TableRowSorter<CondicionPagoTableModel>(modeltable);
        table = new CTable();
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Condición de Pago");
    ...
    public void controlAdd() {
        ...
        RegisterCondicionPago register = new RegisterCondicionPago(frame, usuario);
    ...
    public void cargarTabla() {
        ...
        modeltable.agregarVectorcondicionpago(regla.listar("", "", -1, ""));
        modeloOrdenado.setRowFilter(getFilter());
        table.setAllColumnPreferredWidth();
    }
