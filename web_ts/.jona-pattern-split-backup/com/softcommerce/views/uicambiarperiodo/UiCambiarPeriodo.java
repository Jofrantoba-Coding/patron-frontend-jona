...
public class UiCambiarPeriodo extends JDialog implements InterUiCambiarPeriodo, WindowListener, KeyListener, ActionListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public UiCambiarPeriodo(Main arg0, String id_empresa, java.net.URL path) throws HeadlessException {
        super(arg0);
        frmsys = arg0;
    ...
    private static final Logger LOG = Logger.getLogger(UiCambiarPeriodo.class.getName());
}
