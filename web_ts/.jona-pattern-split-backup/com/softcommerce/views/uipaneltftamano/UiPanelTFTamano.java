 ...
 */
package com.softcommerce.views.uipaneltftamano;
...
import com.softcommerce.formularios.RegisterTamano;
...
import com.softcommerce.general.tablas.TamanoTableModel;
 ...
 * @author TOSHIBA
 */
public class UiPanelTFTamano extends JHInternalFrame implements InterUiPanelTFTamano, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    public CTable table;
    public TamanoTableModel modeltable;
    ...
    public UiPanelTFTamano(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public UiPanelTFTamano(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new TamanoTableModel();
	...
	//txt_idsubfamilia.setBounds(80,25,90,20);
        ...
        tool2.add(txt_descripcionsubfamilia);
        addGrid(pnlp,gbc,1,0,tool2);
    ...
    public void controlAdd() {
        ...
        RegisterTamano register = new RegisterTamano(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectortamano(regla.listar("", "", ""));
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
