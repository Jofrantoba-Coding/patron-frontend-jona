 ...
 */
package com.softcommerce.views.uibuscarncpendientecliente;
...
public class UiBuscarNCPendienteCliente extends CDialog implements InterUiBuscarNCPendienteCliente, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public UiBuscarNCPendienteCliente(Frame arg0, JHInternal arg, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = arg;
    ...
    public void cargarTabla() {
        ...
        List<ContaCab> Listado = regla.listarBuscarNCPendienteCliente(m);
        if (Listado.isEmpty() == true) {
            JOptionPane.showMessageDialog(null, "No se encontraron documentos.", "Informacion", JOptionPane.INFORMATION_MESSAGE);
        }
        mdl_documento.agregarVectorMovInventarioCab(Listado);
        tbl_documento.setAllColumnPreferredWidth();
    }

    public void cargarTablaAntiguo() {
        ContaCab m = new ContaCab();
        m.setIdEmpresa(usuario.getCodempresa());
        m.setIdLocalidad(usuario.getCodlocalidad());
        m.setFInicial(dc_fechainicio.getDate());
        ...
        RnRegContaCab regla = new RnRegContaCab(path);
        mdl_documento.clearTable();
        mdl_documento.agregarVectorMovInventarioCab(regla.listarBuscarNCPendienteCliente(m));
        tbl_documento.setAllColumnPreferredWidth();
    }
