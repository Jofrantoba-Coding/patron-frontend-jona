 ...
 */
package com.softcommerce.views.uiformitempercepcion;
 ...
 */
public class UiFormItemPercepcion extends JDialog implements InterUiFormItemPercepcion, ActionListener {
    ...
    public UiFormItemPercepcion(JHDialog arg0, java.net.URL path, Component comp, boolean sw, int id_item_percepcion) {
        super(arg0);
        this.dialog = arg0;
        this.path = path;
        this.comp = comp;
