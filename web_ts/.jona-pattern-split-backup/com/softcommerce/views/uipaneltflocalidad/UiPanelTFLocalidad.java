 ...
 * @author TOSHIBA
 */
public class UiPanelTFLocalidad
        extends JHInternalFrame implements InterUiPanelTFLocalidad, ListSelectionListener,
        ActionListener {

    public CTable table;
    public LocalidadTableModel modeltable;
    ...
    public UiPanelTFLocalidad(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public UiPanelTFLocalidad(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
        super(title, vPermiso.get(0), vPermiso.get(1), vPermiso.get(2), vPermiso.get(3), vPermiso.get(4), 
                vPermiso.get(5), vPermiso.get(6), vPermiso.get(7), vPermiso.get(8), vPermiso.get(9), vPermiso.get(10), vPermiso.get(11), vPermiso.get(12));
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    ...
    private void inicialize() {
        modeltable = new LocalidadTableModel();
    ...
    public void controlAdd() {
        ...
        RegisterLocalidad register = new RegisterLocalidad(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectorlocalidad(regla.listarGeneral());
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
