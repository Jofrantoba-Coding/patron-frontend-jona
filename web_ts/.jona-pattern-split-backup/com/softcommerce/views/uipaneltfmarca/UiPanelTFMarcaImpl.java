...
public class UiPanelTFMarcaImpl extends UiPanelTFMarca {

    public UiPanelTFMarcaImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFMarcaImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
