...
public class UiPanelTFClasifInventarioImpl extends UiPanelTFClasifInventario {

    public UiPanelTFClasifInventarioImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(areg, title, frm, usuario);
    }

    public UiPanelTFClasifInventarioImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
