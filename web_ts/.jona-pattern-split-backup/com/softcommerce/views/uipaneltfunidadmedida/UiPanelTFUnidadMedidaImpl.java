...
public class UiPanelTFUnidadMedidaImpl extends UiPanelTFUnidadMedida {

    public UiPanelTFUnidadMedidaImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(areg, title, frm, usuario);
    }

    public UiPanelTFUnidadMedidaImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
