 ...
 */
package com.softcommerce.views.uibuscarncpendientedetallecliente;
...
public class UiBuscarNCPendienteDetalleCliente extends CDialog implements InterUiBuscarNCPendienteDetalleCliente, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public UiBuscarNCPendienteDetalleCliente(Frame arg0, JHInternal arg, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = arg;
    ...
    public void cargarTabla() {
        ...
        mdl_documento.agregarVectorMovInventarioCab(regla.listarBuscarNCPendienteDetalleCliente(m));
        tbl_documento.setAllColumnPreferredWidth();
    }
