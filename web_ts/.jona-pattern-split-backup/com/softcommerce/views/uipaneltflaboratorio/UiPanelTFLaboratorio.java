package com.softcommerce.views.uipaneltflaboratorio;
...
import com.softcommerce.general.tablas.LaboratorioTableModel;
...
public class UiPanelTFLaboratorio 
        extends JHInternalFrame 
        implements InterUiPanelTFLaboratorio, ListSelectionListener, FocusListener, KeyListener {

    public CTable table;
    public LaboratorioTableModel modeltable;
    ...
    public UiPanelTFLaboratorio(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public UiPanelTFLaboratorio(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new LaboratorioTableModel();
    ...
    public JPanel getPanelFilter()
    {
        ...
        txtIdLaboratorio.addKeyListener(this);
        txtIdLaboratorio.setColumns(7);
        txtIdLaboratorio.setDocument(new IntegerDocument(6));
        txtIdLaboratorio.addFocusListener(this);
        txtIdLaboratorio.setFont(new Font("Garamond",0,14));
        pnlp.add(txtIdLaboratorio);
    ...
    public RowFilter getFilter() {
        ...
        if (txtIdLaboratorio.getText().trim().length() > 0) {
            filters.add(RowFilter.regexFilter(".*" + txtIdLaboratorio.getText().trim() + ".*", 1));
        }
    ...
    public void focusGained(FocusEvent e) {
        ...
        if (e.getSource() == txtIdLaboratorio) {
            txtIdLaboratorio.selectAll();
        }
    }
    ...
    public void controlAdd() {
        ...
        RegisterLaboratorio register = new RegisterLaboratorio(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectorLaboratorio(regla.listarGeneral());
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
    ...
    public void focusLost(FocusEvent e) {
        if (e.getSource() == txtIdLaboratorio && txtIdLaboratorio.getText().trim().length() > 0) {
            String serie = "000" + txtIdLaboratorio.getText().trim();
            String nuevaserie = serie.substring(serie.length() - 3, serie.length());

            txtIdLaboratorio.setText(nuevaserie);
