...
public class UiPanelTFCorrelativoImpl extends UiPanelTFCorrelativo {

    public UiPanelTFCorrelativoImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFCorrelativoImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
