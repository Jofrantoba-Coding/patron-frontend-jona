 ...
 * @author TOSHIBA
 */
public class UiPanelTFColor extends JHInternalFrame implements InterUiPanelTFColor, View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {

    public CTable table;
    public ColorTableModel modeltable;
    ...
    public UiPanelTFColor(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(title);
        register = areg;
    ...
    public UiPanelTFColor(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        ...
        modeltable = new ColorTableModel();
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectorcolor(regla.listar("", "", usuario.getCodempresa()));
            table.setAllColumnPreferredWidth();
            refresh();
        } catch (Exception e) {
