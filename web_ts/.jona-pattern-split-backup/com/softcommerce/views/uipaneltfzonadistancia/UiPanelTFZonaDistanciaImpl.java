...
public class UiPanelTFZonaDistanciaImpl extends UiPanelTFZonaDistancia {

    public UiPanelTFZonaDistanciaImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFZonaDistanciaImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
