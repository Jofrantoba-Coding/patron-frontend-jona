 ...
 */
package com.softcommerce.views.uibuscaringresodocumentotransito;
...
import com.softcommerce.general.tablas.BuscarFacturaTransitoModel;
...
public class UiBuscarIngresoDocumentoTransito extends JDialog implements InterUiBuscarIngresoDocumentoTransito, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, PropertyChangeListener, MouseListener {
    ...
    private BuscarFacturaTransitoModel modeltblSearch;
    private TableRowSorter<BuscarFacturaTransitoModel> modeloOrdenado;
    ...
    public UiBuscarIngresoDocumentoTransito(Frame arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ari = arg1;
        initialize();
    ...
    private void initialize() {
        ...
        modeltblSearch = new BuscarFacturaTransitoModel();
        modeloOrdenado = new TableRowSorter<BuscarFacturaTransitoModel>(modeltblSearch);
        ...
        setTitle("Buscar Documento en Tránsito - UiBuscarIngresoDocumentoTransito");
    ...
    public void cargarTabla(
        ...
        LogicTransitoCab log = new LogicTransitoCab(path);
        modeloOrdenado.setRowFilter(null);
        modeltblSearch.clearTable();
        try {
            modeltblSearch.agregarArrayRegContaCab(log.listDocTransitoCab(null, id_empresa, null, null, id_punto_venta));
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(UiBuscarIngresoDocumentoTransito.class.getName()).log(Level.SEVERE, null, ex);
