 ...
 * @author TOSHIBA
 */
public class UiPanelTFEmpresa
        extends JHInternalFrame implements InterUiPanelTFEmpresa, View, ListSelectionListener, RowSelection, ControlView, ActionListener {

    public CTable table;
    public EmpresaTableModel modeltable;
    ...
    public UiPanelTFEmpresa(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public UiPanelTFEmpresa(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new EmpresaTableModel();
    ...
    public void controlAdd() {
        ...
        RegisterEmpresa register = new RegisterEmpresa(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarListEmpresa(regla.listarEmpresa(""));
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
            e.printStackTrace();
