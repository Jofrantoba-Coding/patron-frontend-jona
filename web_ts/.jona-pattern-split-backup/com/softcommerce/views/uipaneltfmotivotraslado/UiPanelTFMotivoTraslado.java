 ...
 */
package com.softcommerce.views.uipaneltfmotivotraslado;
...
import com.softcommerce.formularios.RegisterMotivoTraslado;
...
import com.softcommerce.general.tablas.MotivoTrasladoTableModel;
 ...
 * @author TOSHIBA
 */
public class UiPanelTFMotivoTraslado extends JHInternalFrame implements InterUiPanelTFMotivoTraslado, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    public CTable table;
    public MotivoTrasladoTableModel modeltable;
    ...
    public UiPanelTFMotivoTraslado(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public UiPanelTFMotivoTraslado(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new MotivoTrasladoTableModel();
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Motivo Traslado");
    ...
    public void controlAdd() {
        ...
        RegisterMotivoTraslado register = new RegisterMotivoTraslado(frame, usuario);
    ...
    public void cargarTabla() {
        ...
        //modeltable.agregarVectormotivotraslado(regla.listar("","",""));
        modeltable.agregarVectormotivotraslado(regla.BuscaMotivoTraslado(0, "", ""));
        modeloOrdenado.setRowFilter(getFilter());
        table.setAllColumnPreferredWidth();
    }
