...
public class UiPnlTurnoImpl extends UiPnlTurno {

    public UiPnlTurnoImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPnlTurnoImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
