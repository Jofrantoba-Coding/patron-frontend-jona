...
import com.softcommerce.general.tablas.PromocionTableModel;
 ...
 */
public class UiPanelTFPromocion extends JHInternalFrame implements InterUiPanelTFPromocion, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    public CTable table;
    public PromocionTableModel modeltable;
    ...
    public UiPanelTFPromocion(String title, JFrame frame, Usuario usuario) {
    ...
    public UiPanelTFPromocion(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new PromocionTableModel();
    ...
    public void cargarTabla() {
        try {
            ...
            List<Promocion> lista = regla.listar(0, "");
            modeltable.agregarListPromocion(lista);
    ...
    public void controlAdd() {
        try {
            ...
            RegisterPromocion register = new RegisterPromocion(frame, usuario);
