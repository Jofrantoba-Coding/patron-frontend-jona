...
public class UiPnlRepartoImpl extends UiPnlReparto {

    public UiPnlRepartoImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPnlRepartoImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
