...
import com.softcommerce.general.tablas.ClasifClienteTableModel;
 ...
 */
public class UiPanelTFClasifCliente extends JHInternalFrame implements InterUiPanelTFClasifCliente, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {

    public CTable table;
    public ClasifClienteTableModel modeltable;
    ...
    public UiPanelTFClasifCliente(String title, JFrame frame, Usuario usuario) {
    ...
    public UiPanelTFClasifCliente(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        modeltable = new ClasifClienteTableModel();
    ...
    public JPanel getPanelFilter() {
        ...
        //txt_codigo.setBounds(80, 25, 90, 20);
        ...
        //txt_descripcion.setBounds(225, 25, 360, 20);
    ...
    public void cargarTabla() {
        try {
            ...
            List<ClasifCliente> lista = regla.listar(0);
            modeltable.agregarVectorClasifCliente(lista);
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Clasif Cliente", JOptionPane.OK_OPTION);
        }
    }
    ...
    public void controlAdd() {
        try {
            ...
            RegisterClasifCliente register = new RegisterClasifCliente(frame, usuario);
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Clasificación Cliente");
