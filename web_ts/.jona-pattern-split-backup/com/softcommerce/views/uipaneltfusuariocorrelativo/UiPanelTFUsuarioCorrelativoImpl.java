...
public class UiPanelTFUsuarioCorrelativoImpl extends UiPanelTFUsuarioCorrelativo {

    public UiPanelTFUsuarioCorrelativoImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFUsuarioCorrelativoImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
