...
public class UiPanelTFChoferImpl extends UiPanelTFChofer {

    public UiPanelTFChoferImpl(String title, JFrame frame, Usuario usuario) {
        super(title, frame, usuario);
    }

    public UiPanelTFChoferImpl(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
        super(title, frame, usuario, vPermiso);
    }

    public UiPanelTFChoferImpl(String title, JFrame frame, Usuario usuario, boolean vendedor) {
