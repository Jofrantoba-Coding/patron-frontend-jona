 ...
 */
package com.softcommerce.views.uibuscarguiaremisionpdu;
...
import com.softcommerce.general.tablas.BuscarGuiaRemPDUTableModel;
import com.softcommerce.logic.LogicServicioTransporte;
...
public class UiBuscarGuiaRemisionPDU extends JDialog implements InterUiBuscarGuiaRemisionPDU, ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, PropertyChangeListener, MouseListener {
    ...
    private BuscarGuiaRemPDUTableModel modeltblSearch;
    private TableRowSorter<BuscarGuiaRemPDUTableModel> modeloOrdenado;
    ...
    public UiBuscarGuiaRemisionPDU(Main arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        frm = arg0;
        this.path = path;
        this.ari = arg1;
    ...
    private void initialize() {
        ...
        modeltblSearch = new BuscarGuiaRemPDUTableModel();
        modeloOrdenado = new TableRowSorter<BuscarGuiaRemPDUTableModel>(modeltblSearch);
        ...
        tblSearch.getColumnModel().getColumn(0).setPreferredWidth(100);
        tblSearch.getColumnModel().getColumn(1).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(2).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(3).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(4).setPreferredWidth(200);
...
//        ActionListener action24 = new ActionListener(){@Override public void actionPerformed(ActionEvent e){cbEstadoDocumento.requestFocus();}};
//        ((JTextField)dc_fechafin.getDateEditor()).registerKeyboardAction(action24,keystroke24,JComponent.WHEN_FOCUSED);
        ...
        btn_buscar.setBounds(655, 55, 40, 20);
        ...
        tblSearch.getColumnModel().getColumn(0).setPreferredWidth(140);
        tblSearch.getColumnModel().getColumn(1).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(2).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(3).setPreferredWidth(150);
        tblSearch.getColumnModel().getColumn(4).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(5).setPreferredWidth(200);
        tblSearch.getColumnModel().getColumn(6).setPreferredWidth(150);

        setBackground(new Color(245, 245, 245));
        setTitle("Buscar Guia Remision Transportista - UiBuscarGuiaRemisionPDU");
    ...
    public void cargarTabla(
        ...
        //tania
//        modeltblSearch.agregarVectorRegContaCab(regla.listarOrdenCompra("",id_empresa,"","","",id_punto_venta,"Y",frm.getAnio()));
        try {
            modeltblSearch.agregarArrayRegContaCab(regla.listarGuiaRemision("", id_punto_venta, dc_fechainicio.getDate(),
                    dc_fechafin.getDate()));
            //modeltblSearch.fireTableDataChanged();

        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.toString());
        }

//        tblSearch.  getColumn(getColumnName(j)).setPreferredWidth(((j==0)?(lengthColumna + 30):(lengthColumna + 30)));        
//        modeltblSearch.getColumnName(WIDTH)
        ComponentToolKit.centerComponentPosicion(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btn_Refrescar) {
            try {
                ...
                Logger.getLogger(UiBuscarGuiaRemisionPDU.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//            ari.setValueSearch(tblSearch.getValueAt(row,indiceTabla),comp);
            ari.setValueSearch(modeltblSearch.getRegContaCab(row), comp);
            dispose();
        }
    }
