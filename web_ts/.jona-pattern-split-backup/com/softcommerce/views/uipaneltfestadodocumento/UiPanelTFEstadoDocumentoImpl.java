...
public class UiPanelTFEstadoDocumentoImpl extends UiPanelTFEstadoDocumento {

    public UiPanelTFEstadoDocumentoImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(areg, title, frm, usuario);
    }

    public UiPanelTFEstadoDocumentoImpl(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
