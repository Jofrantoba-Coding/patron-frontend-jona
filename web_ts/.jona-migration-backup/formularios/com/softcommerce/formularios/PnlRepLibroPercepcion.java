 ...
 */
public class PnlRepLibroPercepcion extends JInternalFrame implements ActionListener {
    ...
    public PnlRepLibroPercepcion(String title, java.net.URL path, Usuario usuario) {
        super(title);
        this.path = path;
