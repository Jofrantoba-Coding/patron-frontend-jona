 ...
 * @author TOSHIBA
 */
public class PanelTFNotaSalida extends JHInternalFrame implements View, RowSelection, ControlView, ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, InternalFrameListener, MouseListener, PropertyChangeListener, ItemListener {
    ...
    public PanelTFNotaSalida(String title, Main frame, JDesktopPane jdp, Usuario usuario) {
    ...
    public PanelTFNotaSalida(String title, Main frame, JDesktopPane jdp, Usuario usuario, List<Boolean> vPermiso) {
