...
public class PanelTFBoleta
        extends JHInternalFrame
        implements ListSelectionListener, FocusListener, KeyListener, ActionListener,
    ...
    private Gif gif;
    private final Logger logger = Logger.getLogger(PanelTFBoleta.class);
    private CellEditorBtnFactElect cellEditorFE;

    public PanelTFBoleta(String title, JFrame frame, JDesktopPane jdp, Usuario usuario) {
        super(title + " - PanelTFBoleta");
    ...
    public PanelTFBoleta(String title, JFrame frame, JDesktopPane jdp, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFBoleta(String title, JFrame frame, JDesktopPane jdp, Usuario usuario, boolean vendedor) {
        super(title + " - PanelTFBoleta", true, false, false, true, false, true, true, true, true, true, true, true, true);
        this.usuario = usuario;
        this.frame = frame;
        this.jdp = jdp;
        inicialize();
