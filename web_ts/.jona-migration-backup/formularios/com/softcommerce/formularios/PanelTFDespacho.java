...
public class PanelTFDespacho 
    ...
    private RegisterDespacho registeri;
    ...
    public PanelTFDespacho(String title, JFrame frame, JDesktopPane jdp, Usuario usuario) {
        super(title + " - PanelTFDespacho");
        this.usuario = usuario;
        this.frame = frame;
        this.jdp = jdp;
        inicialize();
    }
    public PanelTFDespacho(String title, JFrame frame, JDesktopPane jdp, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFDespacho(String title, JFrame frame, JDesktopPane jdp, Usuario usuario, boolean vendedor) {
        super(title + " - PanelTFDespacho", true, false, false, true, false, true, true, true, true, true, true, true, true);
        this.usuario = usuario;
        this.frame = frame;
        this.jdp = jdp;
        inicialize();
    ...
    public void controlPrint(boolean view) {
        ...
        try {
            ...
            Map parameters = new HashMap();
            parameters.put("ID_REGCONTACAB", getSelectedValue(1));
            ...
            parameters.put("P_TITULO", "Reporte Despacho");
            String rutaRptJasper=com.softcommerce.util.Constans.PATH_RPT_DESPACHO;
            String rutaSubRptJasper=com.softcommerce.util.Constans.PATH_SUB_RPT_DESPACHO;
    ...
    public void controlAdd() {
        ...
        if (registeri == null) {
            registeri = new RegisterDespacho("Detalle de Orden de Recojo", usuario, frame);
    ...
    public void controlNullify() {
        ...
        String id_estado = logicRcc.getIdestadoMovimiento(modeltable.getRecojo(realRowIndex).getIdMovimiento());
        ...
        if (id_estado.trim().equals("001")) {
            JOptionPane.showMessageDialog(this, "La Orden de Recojo ya esta " + descripcion.substring(0, 1).toUpperCase() + descripcion.substring(1, descripcion.length()).toLowerCase() + ". ", "Anular Orden de Recojo", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
