...
public class BuscarTrabajador extends JDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener {
    ...
    public BuscarTrabajador(JHDialog arg1, java.net.URL path) {
        super(arg1);
        this.path = path;
        this.arg11 = arg1;
        initialize();
