 ...
 * @author TOSHIBA
 */
public class PanelTFUnidadMedida extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFUnidadMedida(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(title);
        register = areg;
    ...
    public PanelTFUnidadMedida(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize() {
        ...
        modeltable = new UnidadMedidaTableModel();
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectorunidadmedida(regla.listarGeneral(usuario.getCodempresa()));
            table.setAllColumnPreferredWidth();
            refresh();
        } catch (Exception e) {
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Unidad Medida");
