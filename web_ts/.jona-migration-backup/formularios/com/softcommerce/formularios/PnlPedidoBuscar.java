 ...
 */
public class PnlPedidoBuscar extends JDialog implements ActionListener, MouseListener {
    ...
    public PnlPedidoBuscar(Frame frame, Usuario usuario, java.net.URL ruta, Object wpnlPadre, Component comp, String strform) {
        super(frame, true);
