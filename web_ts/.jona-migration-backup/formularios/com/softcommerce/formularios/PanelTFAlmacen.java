...
public class PanelTFAlmacen
    ...
    public PanelTFAlmacen(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFAlmacen(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
