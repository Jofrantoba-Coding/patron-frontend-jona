...
public class RegisterNotaCredito
        extends JHInternal
        implements ActionListener, FocusListener, ItemListener, TableModelListener {

    private final Logger logger = Logger.getLogger(RegisterNotaCredito.class);
    ...
    public RegisterNotaCredito(PanelTFNotaCredito pnltfnotacredito, String title, Usuario usuario, JFrame frame) {
        super(title + " - RegisterNotaCredito");
    ...
    private void inicialize() {
        ...
        JLabel lblSerie = new JLabel("N° N Crédito");
