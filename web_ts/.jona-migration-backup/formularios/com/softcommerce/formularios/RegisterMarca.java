...
public class RegisterMarca extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterMarca(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterMarca(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
