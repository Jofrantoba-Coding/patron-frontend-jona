...
public class BuscarSalidasEntradas extends CDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public BuscarSalidasEntradas(Frame arg0, JHInternal pnlguia, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = pnlguia;
    ...
    public BuscarSalidasEntradas(Frame arg0, JHInternalFrame pnlguia, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.usuario = usuario;
        initialize();
    ...
    public BuscarSalidasEntradas(Frame arg0, JHInternalDialog arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ari = arg1;
        initialize();
    ...
    private static final Logger LOG = Logger.getLogger(BuscarSalidasEntradas.class.getName());
}
