...
public class PanelTFSubFamilia
    ...
    private final Logger logger = Logger.getLogger(PanelTFSubFamilia.class);

    public PanelTFSubFamilia(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFSubFamilia(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
