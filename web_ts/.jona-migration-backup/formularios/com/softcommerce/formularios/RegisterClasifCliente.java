 ...
 */
public class RegisterClasifCliente extends JHDialog implements ActionListener, ItemListener, KeyListener,FocusListener{
    ...
    public RegisterClasifCliente(Frame arg0,Usuario usuario){
        super(arg0,true);
