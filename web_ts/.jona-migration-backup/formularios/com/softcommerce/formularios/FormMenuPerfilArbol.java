 ...
 */
public class FormMenuPerfilArbol extends JDialog implements ListSelectionListener, ActionListener, FocusListener, KeyListener {
    ...
    /*public static void main(String[] args) {
     ...
     FormMenuPerfilArbol theEntry = new FormMenuPerfilArbol();
     theEntry.setVisible(true);
     }*/
    public FormMenuPerfilArbol() {
        super();
    ...
    public FormMenuPerfilArbol(JFrame frame, Usuario usuario, java.net.URL ruta) {
        super(frame);
    ...
    public FormMenuPerfilArbol(JFrame frame, Usuario usuario, java.net.URL ruta, boolean modal) {
        super(frame, modal);
        this.usuario = usuario;
        this.path = ruta;
        initComponents();
