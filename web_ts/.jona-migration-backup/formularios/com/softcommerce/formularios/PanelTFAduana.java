...
public class PanelTFAduana 
        extends JHInternalFrame 
        implements ListSelectionListener, FocusListener, ActionListener {
    ...
    public PanelTFAduana(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(title);
        register = areg;
    ...
    public PanelTFAduana(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
