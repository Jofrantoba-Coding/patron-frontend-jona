 ...
 */
public class FormAccionPrecioAgregar extends JDialog implements ActionListener {
    ...
    public FormAccionPrecioAgregar(JDialog arg0, java.net.URL path, Component comp, boolean swReg) {
        super(arg0);
    ...
    public FormAccionPrecioAgregar(JDialog arg0, java.net.URL path, Component comp, boolean swReg, AccionPrecio objAccionPrecio) {
        super(arg0);
        this.dialogPadre = arg0;
        this.path = path;
        this.comp = comp;
