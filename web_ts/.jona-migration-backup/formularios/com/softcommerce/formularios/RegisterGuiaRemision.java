...
public class RegisterGuiaRemision
        extends JHInternal
    ...
    private final PanelTFGuiaRemision pnltf;
    ...
    private final Logger logger = Logger.getLogger(RegisterGuiaRemision.class);
    ...
    public RegisterGuiaRemision(PanelTFGuiaRemision pnltf, String title, Usuario usuario, JFrame frm) {
    ...
    private JPanel getPnlGral() {
        ...
        JLabel lblTipoGuia = new JLabel("Tipo Guía");
        ...
        try {
            ...
            if (idMotivoTraslado.equals(MotivoTrasladoEnum.VENTA.getValue())) {
                ...
                report.generarReporte("GuiaRemisionSys", getPrint(codigo), "", "", "",
                        getPrintSubreport(codigo), "", true, false, "Reporte Guías de Remisión");
            }
        } catch (Exception ex) {
    ...
    private void cargarDocumentoReferencia(String id_regconta, String serie, String preimpreso) {
        try {
            ...
            if (!list.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(new JFrame(), "No se encontró documento", usuario.getDescriempresa(), JOptionPane.WARNING_MESSAGE);
            }
        } catch (Exception e) {
            ExceptionHandler.handleException(e, logger);
            JOptionPane.showMessageDialog(this, e.getMessage());
