 ...
 */
public class PnlReparto extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener, MouseListener, PropertyChangeListener {
    ...
    public PnlReparto(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlReparto(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
