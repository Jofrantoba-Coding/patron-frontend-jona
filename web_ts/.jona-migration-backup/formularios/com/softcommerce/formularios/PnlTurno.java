 ...
 */
public class PnlTurno extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PnlTurno(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlTurno(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public void cargarTabla() {
        try {
            RnTurno regla = new RnTurno(path);
            modeloOrdenado.setRowFilter(null);
            modeltable.clearTable();
            List<BeanTurno> lista = regla.listarTurno("");
            modeltable.agregarListTurno(lista);
    ...
    public void controlAdd() {
        ...
        try {
            RegisterTurno register = new RegisterTurno(frame, usuario, null);
    ...
    public void controlModify() {
        ...
        BeanTurno beanCuenta = modeltable.getTurno(realRowIndex);
        setCursor(new Cursor(Cursor.WAIT_CURSOR));
        RegisterTurno register = new RegisterTurno(frame, usuario, beanCuenta);
        register.setPath(path);
        register.setRowSelection(this);
        register.setView(this);
