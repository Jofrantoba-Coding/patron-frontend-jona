 ...
 * @author TOSHIBA
 */
public class PanelTFMotivoNC extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFMotivoNC(String title, JFrame frame, Usuario usuario) {
        super(title);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    public PanelTFMotivoNC(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
