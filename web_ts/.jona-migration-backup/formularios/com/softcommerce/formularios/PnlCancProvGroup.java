...
public class PnlCancProvGroup
    ...
    private final Logger logger = Logger.getLogger(PnlCancProvGroup.class);

    public PnlCancProvGroup(String title, URL path, Main frm, Usuario usuario) {
        super(title);
        this.path = path;
