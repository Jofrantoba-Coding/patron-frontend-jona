...
public class RegisterConsultaStockHistorico
    ...
    private final Logger logger = Logger.getLogger(RegisterConsultaStockHistorico.class);

    public RegisterConsultaStockHistorico(String title, Main frm, JDesktopPane jdp, Usuario usuario) {
        super(title);
        this.frm = frm;
