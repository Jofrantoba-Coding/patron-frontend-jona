...
public class BuscarOrdenCompraSalidaAjuste
        extends CDialog
        implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public BuscarOrdenCompraSalidaAjuste(Main arg0, JHInternal pnlguia, Usuario usuario, java.net.URL path) {
        super(arg0);
        frm = arg0;
        this.path = path;
        this.arg = pnlguia;
