 ...
 * @author TOSHIBA
 */
public class PanelTFTamano extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFTamano(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFTamano(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
