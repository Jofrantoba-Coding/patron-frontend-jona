...
public class PnlCotizacion 
        extends JHInternalFrame implements ListSelectionListener, FocusListener, KeyListener, ActionListener, PropertyChangeListener {
    ...
    private final Logger logger = Logger.getLogger(PnlCotizacion.class);

    public PnlCotizacion(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlCotizacion(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
