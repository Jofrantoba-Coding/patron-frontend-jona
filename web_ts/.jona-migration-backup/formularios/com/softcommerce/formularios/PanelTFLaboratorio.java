...
public class PanelTFLaboratorio 
        extends JHInternalFrame 
        implements ListSelectionListener, FocusListener, KeyListener {
    ...
    public PanelTFLaboratorio(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFLaboratorio(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
