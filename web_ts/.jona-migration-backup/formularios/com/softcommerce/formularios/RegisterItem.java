...
public class RegisterItem
        extends JHDialog
        implements ActionListener, KeyListener, FocusListener, ItemListener, ChangeListener {
    ...
    protected CaracteristicaItemDetalleTableModel modeltableCaracteristica;
    private CTable tableCaracteristica;
    protected ConfigItemTableModel modeltableConfigItem;
    private CTable tableConfigItem;
    protected ItemPercepcionTableModel modeltableItemPercepcion;
    ...
    protected ConfigItemAlmacenTableModel modeltableConfigItemAlmacen;
    private CTable tableConfigItemAlmacen;
    protected ConfigItemCuentaTableModel modeltableConfigItemCuenta;
    ...
    private final Logger logger = Logger.getLogger(RegisterItem.class);
    ...
    public RegisterItem(Main frm, Usuario usuario) {
        super(frm);
    ...
    public RegisterItem(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
    ...
    private void loadTamano() {
        try {
            ...
            cbTamano.addItem("--- Seleccione un Tamaño ---");
