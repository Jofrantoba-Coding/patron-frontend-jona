...
public class RegisterCierreAperturaFacturacion  extends JHDialog implements ActionListener, ItemListener, KeyListener,FocusListener
{
    ...
    public RegisterCierreAperturaFacturacion(Frame arg0,Usuario usuario)
    {
        super(arg0);
    ...
    public RegisterCierreAperturaFacturacion(Dialog arg0,Usuario usuario)
    {
        super(arg0);
        this.usuario = usuario;
	inicialize();
