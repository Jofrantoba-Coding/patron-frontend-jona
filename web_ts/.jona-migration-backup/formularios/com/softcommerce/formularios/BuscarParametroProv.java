...
public class BuscarParametroProv extends JDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener {
    ...
    public BuscarParametroProv(JFrame frm, JHInternal arg1, java.net.URL path) {
        super(frm);
        this.path = path;
        this.ards = arg1;
        initialize();
