...
public class RegisterEstadoDocumento extends AbstractRegister implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterEstadoDocumento(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterEstadoDocumento(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
