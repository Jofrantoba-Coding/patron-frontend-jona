 ...
 */
public class PanelTFTipoDescuento extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener{
    public CTable table;
    ...
    public PanelTFTipoDescuento(String title, JFrame frame, Usuario usuario) {
        super(title, true, true, true,false, false, true, true, false, false, false, false, true, true);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    public PanelTFTipoDescuento(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
