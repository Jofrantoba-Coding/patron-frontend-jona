...
public class BuscarIngresoOrdenCompra extends JDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, PropertyChangeListener, MouseListener {
    ...
    private JCheckBox chkPDU;

    public BuscarIngresoOrdenCompra(Main arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        frm = arg0;
        this.path = path;
        this.ari = arg1;
    ...
    private void initialize() {
        ...
        setTitle("Buscar Orden de Compra - BuscarIngresoOrdenCompra");
    ...
    public RowFilter<Object, Object> getFilter() {
        ...
        if (chkPDU.isSelected()) {
            filters.add(RowFilter.regexFilter("^" + "SI", 10));
        }
