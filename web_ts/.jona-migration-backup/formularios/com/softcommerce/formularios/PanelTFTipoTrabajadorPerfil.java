 ...
 */
public class PanelTFTipoTrabajadorPerfil extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFTipoTrabajadorPerfil(String title, JFrame frame, Usuario usuario) {
        super(title, true, true, true, false, false, true, true, false, false, false, false, true, true);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    public PanelTFTipoTrabajadorPerfil(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
        //super(title, true, true, true, false, false, true, true, false, false, false, false, true, true);
    ...
    public void controlAdd() {
        try {
            ...
            RegisterTipoTrabajadorPerfil register = new RegisterTipoTrabajadorPerfil(frame, usuario);
    ...
    public void controlSearch() {
        try {
            FormMenuPerfilArbol form = new FormMenuPerfilArbol(frame, usuario, path);
            form.setTitle("Permisos Perfil Arbol");
            form.pack();
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Tipo Trabajador Perfil");
