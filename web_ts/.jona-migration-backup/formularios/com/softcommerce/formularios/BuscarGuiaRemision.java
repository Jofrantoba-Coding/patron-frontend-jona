...
public class BuscarGuiaRemision
        extends JDialog
    ...
    private final Logger logger = Logger.getLogger(BuscarGuiaRemision.class);
    
    public BuscarGuiaRemision(Frame arg0, JHInternal arg1, URL path) {
        super(arg0);
        this.path = path;
        this.ari = arg1;
        initialize();
