 ...
 * @author TOSHIBA
 */
public class PanelTFItem
        extends JHInternalFrame
        implements ListSelectionListener, FocusListener, KeyListener, ItemListener {
    ...
    private final Logger logger = Logger.getLogger(PanelTFItem.class);

    public PanelTFItem(String title, Main frame, Usuario usuario) {
        super(title + "- PanelTFItem");
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }

    public PanelTFItem(String title, Main frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFItem(String title, Main frame, Usuario usuario, boolean Vendedor) {
        super(title + "- PanelTFItem", false, false, false, false, false, false, true, true, true, true, true, true, true);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
