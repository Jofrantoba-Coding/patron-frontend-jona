 ...
 */
public class RegisterCotizacion
        extends JInternalFrame
        implements KeyListener, FocusListener, InternalFrameListener, ActionListener,
    ...
    public RegisterCotizacion(Main frm, String title, Usuario usuario, java.net.URL path) {
        super(title);
        this.frm = frm;
