 ...
 */
public class RegisterSocio extends JHDialog implements ActionListener, ItemListener, KeyListener, WindowListener, MouseListener, FocusListener, TableModelListener, ListSelectionListener {
    ...
    public RegisterSocio(Frame arg0, Usuario usuario) {
        super(arg0, true);
    ...
    public RegisterSocio(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
    ...
    public boolean loadRegister() {
        try {
            ...
            beanSocio = regla.beanSocio(Integer.parseInt(rowSelection.getSelectedValue(1).toString()));
            cbo_TipoDocIden.setSelectedItem(beanSocio.getTipo_doc().getAbreviatura());
            txt_NumDoc.setText(beanSocio.getNumero());
            txt_ApePaterno.setText(beanSocio.getPaterno());
            txt_ApeMaterno.setText(beanSocio.getMaterno());
            txt_Nombre.setText(beanSocio.getNombres());
            txt_Descripcion.setText(beanSocio.getDescripcion());
            chkEstado.setSelected(beanSocio.getEstado().equals("A"));
            return true;
        } catch (Exception e) {
    ...
    public String executeInsert() {
        try {
            Socio beanSocio = new Socio();
            beanSocio = llenarBeanSocio();
            String rpta = "";
            RnCliente logicCliente = new RnCliente(path);
            rpta = logicCliente.mantSocio(beanSocio, "I");
            return rpta;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Socio", JOptionPane.OK_OPTION);
            return "";
    ...
    public String executeUpdate() {
        try {
            ...
            String rpta = "";
            RnCliente logicCliente = new RnCliente(path);
            rpta = logicCliente.mantSocio(beanSocio, "A");
            return rpta;
        } catch (Exception e) {
