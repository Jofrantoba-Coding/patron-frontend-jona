 ...
 * @author TOSHIBA
 */
public class PanelTFCorrelativo
    ...
    public PanelTFCorrelativo(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFCorrelativo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
