...
public class BuscarIngresoInventarioInicial extends JDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, PropertyChangeListener, MouseListener {
    ...
    public BuscarIngresoInventarioInicial(Main arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        frm = arg0;
        this.path = path;
        this.ari = arg1;
