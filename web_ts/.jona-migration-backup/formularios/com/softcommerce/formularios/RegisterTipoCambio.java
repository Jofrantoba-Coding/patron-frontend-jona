...
public class RegisterTipoCambio extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener, WindowListener, MouseListener {
    ...
    public RegisterTipoCambio(Frame arg0, Usuario usuario) {
        super(arg0);
