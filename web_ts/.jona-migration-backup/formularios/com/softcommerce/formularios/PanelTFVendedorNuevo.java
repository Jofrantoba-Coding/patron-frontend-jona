 ...
 * @author TOSHIBA
 */
public class PanelTFVendedorNuevo extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFVendedorNuevo(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFVendedorNuevo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
