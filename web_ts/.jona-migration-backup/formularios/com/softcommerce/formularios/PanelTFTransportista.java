 ...
 * @author TOSHIBA
 */
public class PanelTFTransportista extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFTransportista(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFTransportista(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFTransportista(String title, JFrame frame, Usuario usuario, boolean vendedor) {
