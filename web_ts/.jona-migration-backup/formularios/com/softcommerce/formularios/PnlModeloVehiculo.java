 ...
 */
public class PnlModeloVehiculo extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PnlModeloVehiculo(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlModeloVehiculo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
