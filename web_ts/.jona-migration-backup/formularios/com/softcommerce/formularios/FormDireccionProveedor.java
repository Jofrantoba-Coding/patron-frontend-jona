 ...
 */
public class FormDireccionProveedor extends JDialog implements ActionListener{
    ...
    public FormDireccionProveedor(JHDialog arg0,java.net.URL path,Component comp){
        super(arg0);
        this.dialog=arg0;
        this.path = path;
        this.comp=comp;
