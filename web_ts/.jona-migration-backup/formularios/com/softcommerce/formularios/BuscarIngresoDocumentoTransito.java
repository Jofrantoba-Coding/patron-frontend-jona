...
public class BuscarIngresoDocumentoTransito extends JDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, PropertyChangeListener, MouseListener {
    ...
    public BuscarIngresoDocumentoTransito(Frame arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.ari = arg1;
        initialize();
    ...
    private void initialize() {
        ...
        setTitle("Buscar Documento en Tránsito - BuscarIngresoDocumentoTransito");
    ...
    public void cargarTabla(
        ...
        try {
            ...
            Logger.getLogger(BuscarIngresoDocumentoTransito.class.getName()).log(Level.SEVERE, null, ex);
