 ...
 */
public class FormAccionSocio extends JDialog implements ActionListener {
    ...
    protected AccionSocioTableModel modeltableAccionSocio;
    private CTable tableAccionSocio;
    protected AccionPrecioTableModel modeltableAccionPrecio;
    private CTable tableAccionPrecio;
    private Gif gif;

    public FormAccionSocio(JFrame frame, Usuario usuario, java.net.URL ruta, boolean modal) {
        super(frame, modal);
