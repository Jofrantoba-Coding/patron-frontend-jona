 ...
 */
public class PanelTFZonaDistancia extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFZonaDistancia(String title, JFrame frame, Usuario usuario) {
    ...
    public PanelTFZonaDistancia(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
