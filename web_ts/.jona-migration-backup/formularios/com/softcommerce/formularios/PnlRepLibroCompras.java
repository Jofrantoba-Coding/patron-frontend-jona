...
public class PnlRepLibroCompras 
    ...
    private final Logger logger = Logger.getLogger(PnlRepLibroCompras.class);

    public PnlRepLibroCompras(String title, Main frm, Usuario usuario, URL path, String tipo) {
        super(title);
        this.path = path;
