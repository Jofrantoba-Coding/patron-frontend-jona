...
public class RegisterLote extends JDialog {
    ...
    public RegisterLote(Frame owner, String titulo, boolean value, ContaItem bean, OrdenCompraDetalleTableModel model, CellEditorBtnLote cellEditor, String idAlmacen) {
    ...
    public RegisterLote(Frame owner, String titulo, boolean value, ContaItem bean, IngresoDevolucionDespachadoTableModel model, CellEditorBtnLote cellEditor, String idAlmacen) {
        super(owner, titulo, value);
        this.bean = bean;
    ...
    public RegisterLote(Frame owner, String titulo, boolean value, ContaItem bean, DocumentoVentaDetalleTableModel model, CellEditorBtnLote cellEditor, String idAlmacen) {
        super(owner, titulo, value);
        this.bean = bean;
