 ...
 */
public class FormAnexoPadron extends JDialog implements ActionListener {
    ...
    public FormAnexoPadron(JHDialog arg0, java.net.URL path, Component comp, int id_tipo_anexo, AnexoPadronTableModel modelAnexoPadron) {
        super(arg0);
        this.dialog = arg0;
        this.path = path;
        this.comp = comp;
