 ...
 * @author TOSHIBA
 */
public class PanelTFProveedor extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFProveedor(String title, JFrame frame, Usuario usuario) {
        super(title);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    public PanelTFProveedor(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public void controlAdd() {
        ...
        RegisterProveedor register = new RegisterProveedor(frame, usuario);
