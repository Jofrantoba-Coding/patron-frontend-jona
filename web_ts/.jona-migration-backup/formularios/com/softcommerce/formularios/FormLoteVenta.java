...
public class FormLoteVenta
    ...
    private final Logger logger = Logger.getLogger(FormLoteVenta.class);
    ...
    public FormLoteVenta(Main frame, URL path, BeanRegcontaItem beanRci, Object objPadre, Component comp) {
        super(frame);
        this.path = path;
    ...
    public FormLoteVenta(Main frame, URL path, ContaItem beanGuia, Object objPadre, Component comp) {
        super(frame);
        this.path = path;
