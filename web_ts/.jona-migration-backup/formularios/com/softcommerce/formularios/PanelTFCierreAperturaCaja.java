 ...
 * @author TOSHIBA
 */
public class PanelTFCierreAperturaCaja extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFCierreAperturaCaja(String title, JFrame frm, Usuario usuario) {
        super(title);
        this.frame = frm;
    ...
    public PanelTFCierreAperturaCaja(String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
