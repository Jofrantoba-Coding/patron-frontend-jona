 ...
 * @author TOSHIBA
 */
public class PanelTFUsuario extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFUsuario(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFUsuario(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
