 ...
 * @author TOSHIBA
 */
public class PanelTFColor extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFColor(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(title);
        register = areg;
    ...
    public PanelTFColor(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
