 ...
 */
public class RegisterProgReparto extends JHDialog implements ActionListener, MouseListener {
    ...
    public RegisterProgReparto(Frame arg0, Usuario usuario, java.net.URL path, BeanProgramacionReparto beanReparto) {
        super(arg0, true);
