...
public class CambiarCondicionPago extends CDialog implements ActionListener, KeyListener, FocusListener, WindowFocusListener, WindowListener, ItemListener, MouseListener, PropertyChangeListener {
    ...
    public CambiarCondicionPago(JFrame frm, Usuario usuario, java.net.URL path) {
        super(frm);
        this.path = path;
