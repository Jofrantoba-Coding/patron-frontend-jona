...
public class RegisterItemResumen
        extends JHDialog
    ...
    private final Logger logger = Logger.getLogger(RegisterItemResumen.class);

    public RegisterItemResumen(Main frm, Usuario usuario) {
        super(frm);
    ...
    public RegisterItemResumen(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
