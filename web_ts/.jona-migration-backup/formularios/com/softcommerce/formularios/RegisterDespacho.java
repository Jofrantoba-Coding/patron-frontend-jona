...
public class RegisterDespacho
    ...
    private final Logger logger = Logger.getLogger(RegisterDespacho.class);

    public RegisterDespacho(String title, Usuario usuario, JFrame frm) {
        super(title);
