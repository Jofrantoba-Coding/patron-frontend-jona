...
public class RegisterUnidadMedida extends AbstractRegister implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterUnidadMedida(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterUnidadMedida(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
