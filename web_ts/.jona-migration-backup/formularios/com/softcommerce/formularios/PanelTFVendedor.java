 ...
 * @author TOSHIBA
 */
public class PanelTFVendedor extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFVendedor(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public void cargarTabla() {
        try {
            ...
            this.table.getColumnModel().getColumn(6).setCellRenderer(new CellRendererImageEstado());
