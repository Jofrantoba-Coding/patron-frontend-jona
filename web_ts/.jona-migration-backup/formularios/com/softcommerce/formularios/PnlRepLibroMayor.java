...
public class PnlRepLibroMayor extends JInternalFrame implements ActionListener {
    ...
    public PnlRepLibroMayor(String title, Main frm, Usuario usuario, java.net.URL path) {
        super(title);
        this.path = path;
