...
public class RegisterMotivoNotaCredito extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterMotivoNotaCredito(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterMotivoNotaCredito(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
