 ...
 */
public class RegisterTipoDescuento extends JHDialog implements ActionListener, ItemListener, KeyListener,FocusListener{
    ...
    public RegisterTipoDescuento(Frame arg0,Usuario usuario){
        super(arg0,true);
        this.usuario = usuario;
	inicialize();
    }
    
    public RegisterTipoDescuento(Dialog arg0,Usuario usuario){
        super(arg0);
        this.usuario = usuario;
	inicialize();
    }
