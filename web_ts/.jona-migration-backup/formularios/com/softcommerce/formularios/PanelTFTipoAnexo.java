 ...
 * @author TOSHIBA
 */
public class PanelTFTipoAnexo extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFTipoAnexo(String title, JFrame frame, Usuario usuario) {
        super(title);
