...
public class FormAsientoImportar
        extends JDialog
    ...
    private Gif gif;
    private final Logger logger = Logger.getLogger(FormAsientoImportar.class);
    ...
    public FormAsientoImportar(Main frame, Usuario usuario, URL ruta) {
        super(frame, true);
