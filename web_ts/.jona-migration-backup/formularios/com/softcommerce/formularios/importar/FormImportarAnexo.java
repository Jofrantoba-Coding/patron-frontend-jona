...
public class FormImportarAnexo extends JDialog
        implements ListSelectionListener, ActionListener, FocusListener, KeyListener {
    ...
    private final Logger logger = Logger.getLogger(FormImportarAnexo.class);

    public FormImportarAnexo(JFrame frame, Usuario usuario, java.net.URL ruta) {
        super(frame, true);
