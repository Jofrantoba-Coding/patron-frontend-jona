...
public class FormCajaImportar
    ...
    private final Logger logger = Logger.getLogger(FormCajaImportar.class);
    private String tipoGral = "";

    public FormCajaImportar(Main frame, Usuario usuario, URL ruta) {
        super(frame, true);
        this.frmMain = frame;
