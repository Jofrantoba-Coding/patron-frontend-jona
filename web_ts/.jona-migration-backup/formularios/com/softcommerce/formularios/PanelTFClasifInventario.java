 ...
 * @author TOSHIBA
 */
public class PanelTFClasifInventario extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    private JButton cbExport;
    private JMenuItem miInsert;
    private JMenuItem miUpdate;
    private JMenuItem miClone;
    private JMenuItem miDelete;
    private JMenuItem miReport;
    private JMenuItem miClose;
    private JMenuItem miSearch;
    private JMenuItem miDetail;
    private JMenuItem miNullify;
    private JMenuItem miPrint;
    private JMenuItem miPrintFast;
    private JMenuItem miRefresh;
    private JMenuItem miExport;
    private Gif gif;

    public PanelTFClasifInventario(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(title);
        register = areg;
    ...
    public PanelTFClasifInventario(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
    ...
    private void inicialize(boolean swAdd, boolean swModify, boolean swEliminate, boolean swNullify, boolean swClone, boolean swDetails, boolean swSearch, boolean swReport, boolean swExport, boolean swPrint, boolean swPrintFast, boolean swClose, boolean swRefresh) {
        ...
        pnl.add(getPanelRow(), BorderLayout.SOUTH);
        pnl.add(getPanelControl(swAdd, swModify, swEliminate, swNullify, swClone, swDetails, swSearch, swReport, swExport, swPrint, swPrintFast, swClose, swRefresh), BorderLayout.WEST);
        pnl.add(getPanelTable(), BorderLayout.CENTER);
    ...
    public JPanel getPanelControl() {
        ...
        cbExport = new JButton("Exportar", gif.EXCEL);
        cbExport.setPreferredSize(new Dimension(an, ha));
        cbExport.setHorizontalAlignment(SwingConstants.LEFT);
        cbExport.setMnemonic('X');
        cbExport.addActionListener(this);
        cbExport.setOpaque(false);
        cbExport.setIconTextGap(s);
        pnlNorth.add(cbExport);
    ...
    public JPopupMenu getMenuTabla() {
        ...
        miNullify = new JMenuItem("Anular", gif.NULLIFY);
        miNullify.addActionListener(this);
        popupView.add(miNullify);

        miClone = new JMenuItem("Clonar", gif.CLONE);
        miClone.addActionListener(this);
        popupView.add(miClone);

        miDetail = new JMenuItem("Detalle", gif.DETAIL16);
        miDetail.addActionListener(this);
        popupView.add(miDetail);

        miSearch = new JMenuItem("Buscar", gif.SEARCH16);
        miSearch.addActionListener(this);
        popupView.add(miSearch);

        miReport = new JMenuItem("Reporte", gif.REPORT16);
        miReport.addActionListener(this);
        popupView.add(miReport);

        miExport = new JMenuItem("Exportar", gif.EXCEL);
        miExport.addActionListener(this);
        popupView.add(miExport);

        miPrint = new JMenuItem("Imprimir", gif.PRINT16);
        miPrint.addActionListener(this);
        popupView.add(miPrint);

        miPrintFast = new JMenuItem("Imp. Directa", gif.PRINT16);
        miPrintFast.addActionListener(this);
        popupView.add(miPrintFast);

        miClose = new JMenuItem("Cerrar", gif.EXIT16);
        miClose.addActionListener(this);
        popupView.add(miClose);
    ...
    public void cargarTabla() {
        ...
        modeltable.agregarListclasifinventario(regla.listarGeneral());
        table.setAllColumnPreferredWidth();
        refresh();
    }
    ...
    public void controlReport(boolean export) {
        ...
        parameters.put(2, "Clasificación Inventario");
