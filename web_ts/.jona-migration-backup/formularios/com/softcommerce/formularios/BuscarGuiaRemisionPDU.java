...
public class BuscarGuiaRemisionPDU extends JDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, PropertyChangeListener, MouseListener {
    ...
    public BuscarGuiaRemisionPDU(Main arg0, JHInternal arg1, java.net.URL path) {
        super(arg0);
        frm = arg0;
        this.path = path;
        this.ari = arg1;
...
//        ((JTextField)dc_fechafin.getDateEditor()).registerKeyboardAction(action24,keystroke24,JComponent.WHEN_FOCUSED);
        ...
        setTitle("Buscar Guia Remision Transportista - BuscarGuiaRemisionPDU");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btn_Refrescar) {
            try {
                ...
                Logger.getLogger(BuscarGuiaRemisionPDU.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
