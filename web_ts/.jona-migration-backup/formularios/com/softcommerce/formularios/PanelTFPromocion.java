 ...
 */
public class PanelTFPromocion extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFPromocion(String title, JFrame frame, Usuario usuario) {
    ...
    public PanelTFPromocion(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
