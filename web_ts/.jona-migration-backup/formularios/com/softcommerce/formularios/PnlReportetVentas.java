...
public class PnlReportetVentas
        extends JInternalFrame
        implements ActionListener, KeyListener, MouseListener, FocusListener, ItemListener {

    private final Logger logger = Logger.getLogger(PnlReportetVentas.class);
    ...
    public PnlReportetVentas(String title, URL path, Main frm, Usuario usuario, boolean isVenta) {
        super(title);
        this.path = path;
