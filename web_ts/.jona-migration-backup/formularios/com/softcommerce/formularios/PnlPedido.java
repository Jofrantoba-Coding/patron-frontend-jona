 ...
 */
public class PnlPedido extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener, MouseListener, PropertyChangeListener {
    ...
    public PnlPedido(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlPedido(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
