 ...
 */
public class RegisterTipoTrabajador extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterTipoTrabajador(Frame arg0, Usuario usuario, BeanTipoTrabajador wTipoTrabajador) {
        super(arg0, true);
