 ...
 */
public class PanelTFClasifCliente extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFClasifCliente(String title, JFrame frame, Usuario usuario) {
    ...
    public PanelTFClasifCliente(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
