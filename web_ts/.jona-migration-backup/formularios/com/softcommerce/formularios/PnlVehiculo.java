 ...
 */
public class PnlVehiculo extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PnlVehiculo(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlVehiculo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
