 ...
 * @author Sergio
 */
public class FormVentaConversion 
        extends JDialog implements ActionListener, TableModelListener {
    ...
    private Gif gif;
    private RegisterVentaDirecta formVenta;
    ...
    /*public static void main(String[] args) {
     FormVentaConversion theEntry = new FormVentaConversion();
     theEntry.setVisible(true);
     }*/

    public FormVentaConversion(Main frame, RegisterVentaDirecta formVenta, BigDecimal total) {
        super(frame, true);
    ...
    public FormVentaConversion(Main frame, String id_regconta, URL path) {
        super(frame, true);
        swRegistro = false;
        this.path = path;
