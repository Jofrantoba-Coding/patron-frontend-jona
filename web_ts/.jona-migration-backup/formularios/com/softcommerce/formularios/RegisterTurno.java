 ...
 */
public class RegisterTurno extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterTurno(Frame arg0, Usuario usuario, BeanTurno wTurno) {
        super(arg0, true);
