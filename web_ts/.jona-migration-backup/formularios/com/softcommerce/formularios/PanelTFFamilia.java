...
public class PanelTFFamilia
    ...
    private final Logger logger = Logger.getLogger(PanelTFFamilia.class);

    public PanelTFFamilia(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFFamilia(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public void controlAdd() {
        ...
        RegisterFamilia register = new RegisterFamilia(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            modeltable.agregarVectorfamilia(regla.listar("", "", usuario.getCodempresa()));
            modeloOrdenado.setRowFilter(getFilter());
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
