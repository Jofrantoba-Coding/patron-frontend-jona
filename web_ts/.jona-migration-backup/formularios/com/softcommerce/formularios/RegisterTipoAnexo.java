...
public class RegisterTipoAnexo extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterTipoAnexo(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterTipoAnexo(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
