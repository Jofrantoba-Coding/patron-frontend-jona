 ...
 */
public class RegisterMotivoDescuento extends JHDialog implements ActionListener, ItemListener, KeyListener,FocusListener{
    ...
    public RegisterMotivoDescuento(Frame arg0,Usuario usuario){
        super(arg0,true);
        this.usuario = usuario;
	inicialize();
    }
    
    public RegisterMotivoDescuento(Dialog arg0,Usuario usuario){
        super(arg0);
        this.usuario = usuario;
	inicialize();
    }
