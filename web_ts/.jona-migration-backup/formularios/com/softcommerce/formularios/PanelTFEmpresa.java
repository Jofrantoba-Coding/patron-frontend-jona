 ...
 * @author TOSHIBA
 */
public class PanelTFEmpresa
        extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, ActionListener {
    ...
    public PanelTFEmpresa(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFEmpresa(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
