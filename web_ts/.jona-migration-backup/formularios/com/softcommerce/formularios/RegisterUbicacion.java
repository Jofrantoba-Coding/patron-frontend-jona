...
public class RegisterUbicacion
        extends JHDialog implements ItemListener, FocusListener {
    ...
    private final Logger logger = Logger.getLogger(RegisterUbicacion.class);

    public RegisterUbicacion(Frame arg0, Usuario usuario) {
        super(arg0);
