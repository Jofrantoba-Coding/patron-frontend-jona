...
public class RegisterLocalidad extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterLocalidad(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterLocalidad(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
