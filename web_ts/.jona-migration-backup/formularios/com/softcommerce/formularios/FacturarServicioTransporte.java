...
public class FacturarServicioTransporte 
        extends JHInternal 
        implements ActionListener, ItemListener, KeyListener, FocusListener, TableModelListener, MouseListener, ListSelectionListener {
    ...
    public FacturarServicioTransporte(PanelTFServicioTransporte pnltf, String title, Usuario usuario, Main frm) {
...
//        x_seriecorrelativo.addAll(regla_correlativo.listarUsuarioCorrelativo("", usuario.getId_usuario(), "", "", usuario.getCodempresa(), ls_IdTipoDoc, usuario.getCodpuntoventa(), ""));
    ...
    private static final Logger LOG = Logger.getLogger(FacturarServicioTransporte.class.getName());
