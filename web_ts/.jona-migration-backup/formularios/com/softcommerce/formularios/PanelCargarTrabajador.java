 ...
 */
public class PanelCargarTrabajador extends CDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public PanelCargarTrabajador(Frame arg0, JHDialog arg, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = arg;
    ...
    public void cargarTabla() {
        try {
            RnTrabajador logica = new RnTrabajador(path);
            //Vector<Trabajador> lista = logica.listarGeneral();
            List<Trabajador> lista = logica.listarTrabajador("");
            modeloOrdenado.setRowFilter(null);
            mdlTrabajador.clearTable();
            mdlTrabajador.agregarVectortrabajador(lista);
...
//        txt_preimpreso.requestFocus();        
    ...
    private RowFilter<Object, Object> Filtrar() {
