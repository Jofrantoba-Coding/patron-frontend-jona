...
public class PanelTFChofer 
        extends JHInternalFrame 
        implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFChofer(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFChofer(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFChofer(String title, JFrame frame, Usuario usuario, boolean vendedor) {
        super(title + " - PanelTFChofer", true, true, false, false, false, true, false, true, true, true, false, true, true);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    ...
    public void controlAdd() {
        ...
        //RegisterChofer register = new RegisterChofer(frame, usuario);
        RegisterChofer register = new RegisterChofer(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            ...
            List<Anexo> listAnexo = regla.listAnexo("7", "", "", "", "");
