 ...
 */
public class RegisterPromocion extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterPromocion(Frame arg0, Usuario usuario) {
        super(arg0, true);
