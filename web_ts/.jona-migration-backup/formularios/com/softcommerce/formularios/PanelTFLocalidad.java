 ...
 * @author TOSHIBA
 */
public class PanelTFLocalidad
        extends JHInternalFrame implements ListSelectionListener,
        ActionListener {
    ...
    public PanelTFLocalidad(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFLocalidad(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
