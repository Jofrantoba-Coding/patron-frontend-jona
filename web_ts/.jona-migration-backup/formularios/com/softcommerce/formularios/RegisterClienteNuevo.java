...
public class RegisterClienteNuevo
        extends JHDialog
    ...
    private final Logger logger = Logger.getLogger(RegisterClienteNuevo.class);
    //
    private JTextField txtNumDias;
    private JComboBox cboCondicionPago;

    public RegisterClienteNuevo(Frame arg0, Usuario usuario) {
        super(arg0, true);
    ...
    public RegisterClienteNuevo(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
