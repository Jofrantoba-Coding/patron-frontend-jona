...
public class SessionSystem
        /*extends JDialog
        implements WindowListener, KeyListener, ActionListener, FocusListener, ItemListener */{

    /*private final Logger logger = Logger.getLogger(SessionSystem.class);

    private static final long serialVersionUID = 1L;
    private final Main frmsys;
    ...
    private JComboBox cboMultiEmpresa;
    private ComboModelBdEmpresa cboModelBdEmpresa;
    private JComboBox cboPuntoVenta;
    private String pass_se;
    private String pass_ce;
    ...
    private URL path;
    private int estaEnPass;
    private int saleDeSede = 0;

    public SessionSystem(Main arg0) throws HeadlessException {
        super(arg0);
        frmsys = arg0;
        inicialize();
    ...
    private void getCalendarioBoton(JDateChooser jdateChooser) {
        jdateChooser.getCalendarButton().doClick();
    }

    private void loadConexionEmpresa() {
    ...
    private JPanel getPnlDataEmpresa() {
        JPanel pnlPrinc = new JPanel(new BorderLayout());
    ...
    private void setDataEmpresaConstans() {
        try {
            String userEmpresa;
            if (Constans.SWMULTIEMPRESA) {
    ...
    private void setDataEmpresa(String userEmpresa)
            throws Exception {
        try {
    ...
    private void setDataParametrosEmpresa(String userEmpresa) throws Exception {
        try {
            RnUsuario logiUser = new RnUsuario(this.path);
    ...
    private Boolean getParametroBoolean(List<BdEmpresaParametro> listParametros, ParametroEmpresaEnum paramEmpEnum, Object constante, String nombreConstante) {
    ...
    private Integer getParametroInteger(List<BdEmpresaParametro> listParametros, ParametroEmpresaEnum paramEmpEnum, Object constante, String nombreConstante) {
        boolean paramExist = false;
        for (BdEmpresaParametro parametro : listParametros) {
            if (parametro.getDescripcion().equals(paramEmpEnum.name())) {
    ...
    private void setPathRepors(String userEmpresa)
            throws Exception {
        try {
            RnUsuario logiUser = new RnUsuario(this.path);
    ...
    private String getPathReport(List<BdEmpresaReport> listreports, String nameReport) {
