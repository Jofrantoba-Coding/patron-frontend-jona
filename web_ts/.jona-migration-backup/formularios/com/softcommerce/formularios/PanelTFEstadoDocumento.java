 ...
 * @author TOSHIBA
 */
public class PanelTFEstadoDocumento extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFEstadoDocumento(AbstractRegister areg, String title, JFrame frm, Usuario usuario) {
        super(title);
        register = areg;
    ...
    public PanelTFEstadoDocumento(AbstractRegister areg, String title, JFrame frm, Usuario usuario, List<Boolean> vPermiso) {
