 ...
 */
public class PanelTFProveedorNuevo extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener, MouseListener {
    ...
    public PanelTFProveedorNuevo(String title, JFrame frame, Usuario usuario) {
        super(title + " - PanelTFProveedorNuevo", true, true, true, false, false, true, true, false, true, false, false, true, true);
    ...
    public PanelTFProveedorNuevo(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFProveedorNuevo(String title, JFrame frame, Usuario usuario, boolean vendedor) {
        super(title + " - PanelTFProveedorNuevo", false, false, false, false, false, true, true, false, true, false, false, true, true);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
        initListener();
