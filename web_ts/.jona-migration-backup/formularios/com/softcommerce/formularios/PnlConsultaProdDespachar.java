 ...
 */
public class PnlConsultaProdDespachar extends JInternalFrame implements KeyListener, FocusListener, ActionListener, ChangeListener, MouseListener, DocumentListener {
    ...
    public PnlConsultaProdDespachar(String title, java.net.URL path, Main frm, Usuario usuario) {
        super(title);
        this.path = path;
        this.frmMain = frm;
    ...
    private void buscarAnexo(JTextField txtAnexo, JTextField txtAnexoDesc, String id_tipo_anexo) {
        try {
            ...
            //FormBuscarAnexo objBuscarAnexo = new FormBuscarAnexo(frmMain, this, path, txtAnexo, usuario, id_tipo_anexo, "PnlConsultaProdDespachar");
