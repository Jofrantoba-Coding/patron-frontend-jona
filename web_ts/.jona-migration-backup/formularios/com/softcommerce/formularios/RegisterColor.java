...
public class RegisterColor extends AbstractRegister implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterColor(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterColor(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
