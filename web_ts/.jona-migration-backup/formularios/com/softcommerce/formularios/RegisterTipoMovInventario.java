...
public class RegisterTipoMovInventario extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {
    ...
    public RegisterTipoMovInventario(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }

    public RegisterTipoMovInventario(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
