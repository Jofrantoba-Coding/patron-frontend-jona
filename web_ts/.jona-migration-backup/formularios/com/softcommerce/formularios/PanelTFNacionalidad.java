 ...
 * @author TOSHIBA
 */
public class PanelTFNacionalidad
    ...
    public PanelTFNacionalidad(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFNacionalidad(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public void controlAdd() {
        ...
        RegisterNacionalidad register = new RegisterNacionalidad(frame, usuario);
    ...
    public void cargarTabla() {
        try {
            RnNacionalidad regla = new RnNacionalidad(path);
            modeloOrdenado.setRowFilter(null);
            modeltable.clearTable();
            modeltable.agregarVectorNacionalidad(regla.listarUbicacion(""));
            table.setAllColumnPreferredWidth();
        } catch (Exception e) {
