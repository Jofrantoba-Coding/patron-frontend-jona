 ...
 */
public class RegisterMarcaVehiculo extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener {

    private Usuario usuario;
    private JTextField txt_Codigo;
    private JTextField txt_Descripcion;
    private JCheckBox chkEstado;
    private BeanMarcaVehiculo beanMarcaVehiculo;

    public RegisterMarcaVehiculo(Frame arg0, Usuario usuario, BeanMarcaVehiculo wMarcaVehiculo) {
        super(arg0, true);
    ...
    public boolean loadRegister() {
        try {
            if (beanMarcaVehiculo != null) {
                txt_Codigo.setText(beanMarcaVehiculo.getId_marca());
                txt_Descripcion.setText(beanMarcaVehiculo.getDescripcion());
                chkEstado.setSelected(beanMarcaVehiculo.getEstado().equals("A"));
            }
            return true;
        } catch (Exception e) {
    ...
    public String executeInsert() {
        try {
            ...
            BeanMarcaVehiculo bean = new BeanMarcaVehiculo();
            bean.setId_marca(txt_Codigo.getText());
            ...
            String rpta = "";
            rpta = logic.mantMarcaVehiculo(bean, "I");
            return rpta;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Sistema", JOptionPane.OK_OPTION);
            return "";
    ...
    public String executeUpdate() {
        try {
            ...
            bean.setId_empresa(usuario.getCodempresa());
            String rpta = "";
            rpta = logic.mantMarcaVehiculo(bean, "A");
            return rpta;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Sistema", JOptionPane.OK_OPTION);
            return "";
    ...
    public boolean executeDelete() {
        try {
            ...
            bean.setId_empresa(usuario.getCodempresa());
            String rpta = "";
            rpta = logic.mantMarcaVehiculo(bean, "E");
            return true;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Sistema", JOptionPane.OK_OPTION);
            return false;
