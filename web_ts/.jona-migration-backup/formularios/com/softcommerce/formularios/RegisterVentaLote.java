...
public class RegisterVentaLote
    ...
    private final Logger logger = Logger.getLogger(RegisterVentaLote.class);
    ...
    public RegisterVentaLote(Main frm, String title, Usuario usuario, URL path) {
        super(title);
    ...
    private void agregarItem() {
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterVentaLote.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
