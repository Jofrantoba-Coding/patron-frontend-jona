...
public class RegisterVentaDirecta
    ...
    private final Logger logger = Logger.getLogger(RegisterVentaDirecta.class);
    ...
    public RegisterVentaDirecta(Main frm, String title, Usuario usuario, java.net.URL path) {
        super(title);
    ...
    private void agregarItem(double num, boolean swButton) {
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterVentaDirecta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void insertDocumento(boolean swDespacho) throws Exception {
        try {
            logger.info("RegisterVentaDirecta insertDocumento inicio");
            ...
            logger.info("RegisterVentaDirecta insertDocumento fin");
        }
    }
