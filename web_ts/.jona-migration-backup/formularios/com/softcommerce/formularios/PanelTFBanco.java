 ...
 * @author TOSHIBA
 */
public class PanelTFBanco 
        extends JHInternalFrame implements View, ListSelectionListener, RowSelection, ControlView, WindowListener, FocusListener, KeyListener, ActionListener {
    ...
    public PanelTFBanco(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFBanco(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
    ...
    public PanelTFBanco(String title, JFrame frame, Usuario usuario, boolean vendedor) {
