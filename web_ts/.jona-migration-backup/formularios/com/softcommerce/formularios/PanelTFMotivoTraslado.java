 ...
 * @author TOSHIBA
 */
public class PanelTFMotivoTraslado extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFMotivoTraslado(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PanelTFMotivoTraslado(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
