...
public class FrmDetalleDocSunat
        extends JDialog
    ...
    private final Logger logger = Logger.getLogger(FrmDetalleDocSunat.class);
    ...
    public FrmDetalleDocSunat(URL path, Main frm, Usuario usuario) {
        super(frm, true);
        this.path = path;
