 ...
 */
public class RegisterVehiculo extends JHDialog implements ActionListener, ItemListener, KeyListener, FocusListener, MouseListener {
    ...
    public RegisterVehiculo(JFrame arg0, Usuario usuario, BeanVehiculo wVehiculo) {
        super(arg0, true);
