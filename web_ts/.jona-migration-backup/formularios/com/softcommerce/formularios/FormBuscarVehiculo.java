 ...
 */
public class FormBuscarVehiculo extends JDialog implements ListSelectionListener, KeyListener, ActionListener, MouseListener, ItemListener, FocusListener {
    ...
    public FormBuscarVehiculo(Frame arg0, JHDialog arg1, java.net.URL path, Component comp, Usuario usuario) {
        super(arg0);
    ...
    public FormBuscarVehiculo(Frame arg0, JHInternal arg1, java.net.URL path, Component comp, Usuario usuario) {
        super(arg0);
        this.frmMain = (Main) arg0;
        this.path = path;
