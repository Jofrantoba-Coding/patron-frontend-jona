...
public class BuscarSolicitudTransferencia extends CDialog implements ActionListener, KeyListener, WindowListener, ItemListener, FocusListener, MouseListener, PropertyChangeListener {
    ...
    public BuscarSolicitudTransferencia(Frame arg0, JHInternal arg, Usuario usuario, java.net.URL path) {
        super(arg0);
        this.path = path;
        this.arg = arg;
    ...
    private void initialize() {
        ...
        setTitle("Buscar Solicitud de Transferencia - BuscarSolicitudTransferencia");
