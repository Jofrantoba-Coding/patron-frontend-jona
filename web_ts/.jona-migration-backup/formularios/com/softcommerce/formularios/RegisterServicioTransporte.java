...
public class RegisterServicioTransporte 
        extends JHInternal 
    ...
    public RegisterServicioTransporte(PanelTFServicioTransporte pnltf, String title, Usuario usuario, Main frm) {
...
//            mdl_servicio_transporte.clearTable();
    ...
    private static final Logger LOG = Logger.getLogger(RegisterServicioTransporte.class.getName());
