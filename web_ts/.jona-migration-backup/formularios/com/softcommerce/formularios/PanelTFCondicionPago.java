 ...
 * @author TOSHIBA
 */
public class PanelTFCondicionPago extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PanelTFCondicionPago(String title, JFrame frame, Usuario usuario) {
        super(title);
        this.usuario = usuario;
        this.frame = frame;
        inicialize();
    }
    public PanelTFCondicionPago(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
