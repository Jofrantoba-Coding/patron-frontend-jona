 ...
 */
public class PnlCotizacionAddItem 
        extends JDialog 
        implements KeyListener, FocusListener, ActionListener, ItemListener, MouseListener, ListSelectionListener {
    ...
    public PnlCotizacionAddItem(JHDialog frm, String title, Usuario usuario, java.net.URL path, Component comp) {
        super(frm);
        //this.frm = frm;
