...
public class PnlRepLibroCaja extends JInternalFrame implements ActionListener {
    ...
    public PnlRepLibroCaja(String title, Main frm, Usuario usuario, java.net.URL path, String tipo) {
        super(title);
        this.path = path;
