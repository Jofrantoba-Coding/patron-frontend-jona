...
public class PnlUbicacion
        extends JHInternalFrame
        implements ListSelectionListener, MouseListener, KeyListener, ItemListener, FocusListener {

    private final Logger logger = Logger.getLogger(PnlUbicacion.class);
    ...
    public PnlUbicacion(String title, JFrame frame, Usuario usuario) {
        super(title);
    ...
    public PnlUbicacion(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
