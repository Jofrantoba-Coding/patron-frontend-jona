...
public class RegisterFamilia
    ...
    private final Logger logger = Logger.getLogger(RegisterFamilia.class);
    
    public RegisterFamilia(Frame arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
    
    public RegisterFamilia(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
    }
