 ...
 */
public class PnlTipoTrabajador extends JHInternalFrame implements ListSelectionListener, WindowListener, FocusListener, KeyListener, ActionListener, ItemListener {
    ...
    public PnlTipoTrabajador(String title, JFrame frame, Usuario usuario) {
    ...
    public PnlTipoTrabajador(String title, JFrame frame, Usuario usuario, List<Boolean> vPermiso) {
