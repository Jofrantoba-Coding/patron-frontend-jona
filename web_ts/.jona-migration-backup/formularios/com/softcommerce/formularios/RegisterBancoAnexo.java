...
public class RegisterBancoAnexo
        extends JHDialog
    ...
    private final Logger logger = Logger.getLogger(RegisterBancoAnexo.class);

    public RegisterBancoAnexo(Frame arg0, Usuario usuario) {
        super(arg0, true);
    ...
    public RegisterBancoAnexo(Dialog arg0, Usuario usuario) {
        super(arg0);
        this.usuario = usuario;
        inicialize();
        initListener();
    ...
    public boolean isRegisterValid() {
        ...
        if (cbo_TipoDocIden.getSelectedIndex() < 1) {
            JOptionPane.showMessageDialog(this, "Para " + namemode + " un Cliente, debes Seleccionar un Tipo de Documento.", "Datos incompletos de Banco", JOptionPane.CANCEL_OPTION);
        ...
        if (cbo_TipoDocIden.getSelectedItem().equals("DNI")) {
            ...
            if (txt_ApePaterno.getText().trim().length() == 0) {
                JOptionPane.showMessageDialog(this, "Para " + namemode + " un Banco, debes " + "especificar su Apellido Paterno.", "Datos incompletos del Banco", JOptionPane.CANCEL_OPTION);
            ...
            if (txt_ApeMaterno.getText().trim().length() == 0) {
                JOptionPane.showMessageDialog(this, "Para " + namemode + " un Banco, debes " + "especificar su Apellido Materno.", "Datos incompletos del Banco", JOptionPane.CANCEL_OPTION);
            ...
            if (txt_Nombre.getText().trim().length() == 0) {
                JOptionPane.showMessageDialog(this, "Para " + namemode + " un Banco, debes " + "especificar su Nombre.", "Datos incompletos del Banco", JOptionPane.CANCEL_OPTION);
        ...
        if (txt_Descripcion.getText().trim().length() == 0) {
            JOptionPane.showMessageDialog(this, "Para " + namemode + " un Banco, debes " + "especificar su Descripcion.", "Datos incompletos del Banco", JOptionPane.CANCEL_OPTION);
        ...
        if (cbo_Nacionalidad.getSelectedIndex() < 1) {
            JOptionPane.showMessageDialog(this, "Para " + namemode + " un Banco, debes Seleccionar una Nacionalidad.", "Datos incompletos de Banco", JOptionPane.CANCEL_OPTION);
    ...
    public boolean loadRegister() {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Banco", JOptionPane.OK_OPTION);
            return false;
        }
    }
    ...
    public String executeInsert() {
        try {
            ...
            return logicAnexo.mantBanco(beanAnexo, "I");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Banco", JOptionPane.OK_OPTION);
            return "";
        }
    ...
    public String executeUpdate() {
        try {
            ...
            beanAnexo = llenarBeanAnexo();
            RnAnexo logicAnexo = new RnAnexo(path);
            return logicAnexo.mantBanco(beanAnexo, "A");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Banco", JOptionPane.OK_OPTION);
            return "";
        }
