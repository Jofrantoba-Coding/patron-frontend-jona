...
public class FormConversion
    ...
    private final Logger logger = Logger.getLogger(FormConversion.class);
    ...
    public FormConversion(Usuario usuario) {
    ...
    public FormConversion(Usuario usuario, JDialog dialogContenerdor) {
        this.usuario = usuario;
