...
import { JBoxLayout, BOX_LAYOUT_DEFAULTS } from './BoxLayout';
  ...
  argTypes: {
    direction: {
      ...
      table: {
        ...
        defaultValue: { summary: BOX_LAYOUT_DEFAULTS.direction },
      },
    },
    gap: {
      ...
      table: {
        ...
        defaultValue: { summary: BOX_LAYOUT_DEFAULTS.gap },
      },
    },
    alignItems: {
      ...
      table: {
        ...
        defaultValue: { summary: BOX_LAYOUT_DEFAULTS.alignItems },
      },
    },
    justifyContent: {
      ...
      table: {
        ...
        defaultValue: { summary: BOX_LAYOUT_DEFAULTS.justifyContent },
      },
    },
    wrap: {
      ...
      table: {
        ...
        defaultValue: { summary: String(BOX_LAYOUT_DEFAULTS.wrap) },
      },
    },
  },
};
