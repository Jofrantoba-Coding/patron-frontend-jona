...
import { JSidebarLayout, SIDEBAR_LAYOUT_DEFAULTS } from './SidebarLayout';
  ...
  argTypes: {
    ...
    collapsible: {
      ...
      table: {
        ...
        defaultValue: { summary: String(SIDEBAR_LAYOUT_DEFAULTS.collapsible) },
      },
    },
    defaultCollapsed: {
      ...
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: String(SIDEBAR_LAYOUT_DEFAULTS.defaultCollapsed) },
      },
    },
    sidebarWidth: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: SIDEBAR_LAYOUT_DEFAULTS.sidebarWidth },
      },
    },
    header: {
