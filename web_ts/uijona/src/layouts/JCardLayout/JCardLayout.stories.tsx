...
import { JCardLayout, JCARD_LAYOUT_DEFAULTS } from './JCardLayout';
import { JFlowLayout } from '../JFlowLayout/JFlowLayout';
import { JBoxLayout } from '../JBoxLayout/JBoxLayout';
...
const meta: Meta<typeof JCardLayout> = {
  ...
  argTypes: {
    activeCard: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JCARD_LAYOUT_DEFAULTS.gap },
      },
    },
  },
};
