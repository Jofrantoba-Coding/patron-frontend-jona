...
import { JFlowLayout, FLOW_LAYOUT_DEFAULTS } from './FlowLayout';
  ...
  argTypes: {
    gap: {
      ...
      table: {
        ...
        defaultValue: { summary: FLOW_LAYOUT_DEFAULTS.gap },
      },
    },
    alignItems: {
      ...
      table: {
        ...
        defaultValue: { summary: FLOW_LAYOUT_DEFAULTS.alignItems },
      },
    },
    justifyContent: {
      ...
      table: {
        ...
        defaultValue: { summary: FLOW_LAYOUT_DEFAULTS.justifyContent },
      },
    },
    wrap: {
      ...
      table: {
        ...
        defaultValue: { summary: String(FLOW_LAYOUT_DEFAULTS.wrap) },
      },
    },
  },
};
