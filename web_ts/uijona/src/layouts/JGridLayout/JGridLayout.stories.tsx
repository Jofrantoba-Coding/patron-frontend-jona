...
import { JGridLayout, JGRID_LAYOUT_DEFAULTS } from './JGridLayout';
  ...
  argTypes: {
    gap: {
      ...
      table: {
        ...
        defaultValue: { summary: JGRID_LAYOUT_DEFAULTS.gap },
      },
    },
    columns: {
    ...
    autoFitMin: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JGRID_LAYOUT_DEFAULTS.autoFitMin },
      },
    },
    placement: {
      ...
      table: {
        ...
        defaultValue: { summary: JGRID_LAYOUT_DEFAULTS.placement },
      },
    },
  },
};
