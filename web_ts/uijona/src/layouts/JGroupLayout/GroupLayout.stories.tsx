...
import { JGroupLayout, GROUP_LAYOUT_DEFAULTS } from './GroupLayout';
...
const meta: Meta<typeof JGroupLayout> = {
  ...
  argTypes: {
    mode: {
      ...
      table: {
        type: { summary: 'GroupLayoutMode' },
        defaultValue: { summary: GROUP_LAYOUT_DEFAULTS.mode },
      },
    },
    gap: {
      ...
      table: {
        ...
        defaultValue: { summary: GROUP_LAYOUT_DEFAULTS.gap },
      },
    },
    placement: {
      ...
      table: {
        ...
        defaultValue: { summary: GROUP_LAYOUT_DEFAULTS.placement },
      },
    },
    columns: {
    ...
    autoFitMin: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: GROUP_LAYOUT_DEFAULTS.autoFitMin },
      },
    },
  },
};
