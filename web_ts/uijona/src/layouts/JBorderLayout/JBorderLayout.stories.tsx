...
import { JBorderLayout, JBORDER_LAYOUT_DEFAULTS } from './JBorderLayout';
...
const meta: Meta<typeof JBorderLayout> = {
  ...
  argTypes: {
    ...
    northClassName: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JBORDER_LAYOUT_DEFAULTS.northClassName },
      },
    },
    southClassName: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JBORDER_LAYOUT_DEFAULTS.southClassName },
      },
    },
    westClassName: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JBORDER_LAYOUT_DEFAULTS.westClassName },
      },
    },
    eastClassName: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JBORDER_LAYOUT_DEFAULTS.eastClassName },
      },
    },
    centerClassName: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JBORDER_LAYOUT_DEFAULTS.centerClassName },
      },
    },
  },
};
