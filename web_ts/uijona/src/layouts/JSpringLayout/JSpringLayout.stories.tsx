...
import { JSpringLayout, JSPRING_LAYOUT_DEFAULTS } from './JSpringLayout';
  ...
  argTypes: {
    gap: {
      ...
      table: {
        ...
        defaultValue: { summary: JSPRING_LAYOUT_DEFAULTS.gap },
      },
    },
    placement: {
      ...
      table: {
        ...
        defaultValue: { summary: JSPRING_LAYOUT_DEFAULTS.placement },
      },
    },
    autoFitMin: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JSPRING_LAYOUT_DEFAULTS.autoFitMin },
      },
    },
    minHeight: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JSPRING_LAYOUT_DEFAULTS.minHeight },
      },
    },
  },
};
