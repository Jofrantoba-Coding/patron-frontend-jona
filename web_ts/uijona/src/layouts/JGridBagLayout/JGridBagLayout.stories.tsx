...
import { JGridBagLayout, JGRID_BAG_LAYOUT_DEFAULTS } from './JGridBagLayout';
  ...
  argTypes: {
    gap: {
      ...
      table: {
        ...
        defaultValue: { summary: JGRID_BAG_LAYOUT_DEFAULTS.gap },
      },
    },
    placement: {
      ...
      table: {
        ...
        defaultValue: { summary: JGRID_BAG_LAYOUT_DEFAULTS.placement },
      },
    },
    autoFitMin: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: JGRID_BAG_LAYOUT_DEFAULTS.autoFitMin },
      },
    },
    dense: {
      ...
      table: {
        ...
        defaultValue: { summary: String(JGRID_BAG_LAYOUT_DEFAULTS.dense) },
      },
    },
    columns: {
