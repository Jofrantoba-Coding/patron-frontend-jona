...
import { JMarketingCTA } from './JMarketingCTA';

const meta: Meta<typeof JMarketingCTA> = {
  title: 'Organisms/JMarketingCTA',
  component: JMarketingCTA,
  tags: ['autodocs'],
  args: { onPrimaryClick: fn() },
};

export default meta;
type Story = StoryObj<typeof JMarketingCTA>;
