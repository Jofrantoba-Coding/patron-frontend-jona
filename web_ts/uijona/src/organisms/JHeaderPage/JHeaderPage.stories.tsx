...
import { JHeaderPage } from './JHeaderPage';
import { JButton } from '../../atoms/JButton/JButton';
import { JUserAvatar } from '../../molecules/JUserAvatar';
import { JPanel } from '../../atoms/JPanel/JPanel';

const meta: Meta<typeof JHeaderPage> = {
  title: 'Organisms/JHeaderPage',
  component: JHeaderPage,
  tags: ['autodocs'],
  parameters: { layout: 'fullscreen' },
};
export default meta;
type Story = StoryObj<typeof JHeaderPage>;
