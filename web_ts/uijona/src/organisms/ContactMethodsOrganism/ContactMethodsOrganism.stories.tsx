...
import { ContactMethodsOrganism } from './ContactMethodsOrganism';

const meta: Meta<typeof ContactMethodsOrganism> = {
  title: 'Organisms/ContactMethodsOrganism',
  component: ContactMethodsOrganism,
  tags: ['autodocs'],
};

export default meta;
type Story = StoryObj<typeof ContactMethodsOrganism>;
