...
export const EmptyStateMoleculeView: React.FC<InterEmptyStateMolecule> = ({
  ...
  <div
    className={cn('flex w-full flex-col items-center justify-center gap-4 rounded-md border border-dashed border-neutral-300 bg-white px-6 py-10 text-center', className)}
    {...props}
  >
    {icon && (
