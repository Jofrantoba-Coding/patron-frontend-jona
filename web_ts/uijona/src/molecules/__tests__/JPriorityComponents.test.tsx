...
import { JNumberInput } from '../JNumberInput';
...
describe('Priority 4 app molecules', () => {
  it('JSearchInput emits search and clear events', () => {
    const onSearch = vi.fn();
    const onClear = vi.fn();
    render(<JSearchInput defaultValue="orders" onSearch={onSearch} onClear={onClear} />);
  ...
  it('JNumberInput increments, decrements and clamps values', () => {
    const onValueChange = vi.fn();
    render(<JNumberInput defaultValue={1} min={0} max={2} onValueChange={onValueChange} />);
  ...
  it('JStatCard renders metric content', () => {
    render(<JStatCard label="Revenue" value="$1,200" trendLabel="+4%" description="this week" />);
