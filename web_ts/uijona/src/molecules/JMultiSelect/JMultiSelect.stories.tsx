...
import { JMultiSelect } from './JMultiSelect';
...
const meta: Meta<typeof JMultiSelect> = {
  title: 'Molecules/JMultiSelect',
  component: JMultiSelect,
  tags: ['autodocs'],
  args: {
    options: SKILLS,
    onChange: fn(),
...
export default meta;
type Story = StoryObj<typeof JMultiSelect>;
