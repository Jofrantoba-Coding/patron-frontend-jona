...
import type { JDataTableColumn, InterJDataTable } from './InterJDataTable';
import { JPanel } from '../../atoms/JPanel/JPanel';
import { JLabel } from '../../atoms/JLabel';

// Non-generic wrapper for Storybook type inference
const DataTableStory = (props: InterJDataTable<Record<string, unknown>>) => (
  <JDataTable {...props} />
);
...
const COLUMNS: JDataTableColumn<Record<string, unknown>>[] = [
