// RatingMoleculeView.tsx — JONA View (render puro)
...
export const RatingMoleculeView: React.FC<RatingMoleculeViewProps> = ({
          ...
          >
            <svg
              ...
              className={cn(
                ...
                filled ? 'fill-yellow-400 stroke-yellow-400' : 'fill-neutral-200 stroke-neutral-300'
              )}
            >
