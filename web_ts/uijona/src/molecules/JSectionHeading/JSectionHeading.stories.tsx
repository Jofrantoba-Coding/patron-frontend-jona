...
import { JSectionHeading } from './JSectionHeading';

const meta: Meta<typeof JSectionHeading> = {
  title: 'Molecules/JSectionHeading',
  component: JSectionHeading,
  tags: ['autodocs'],
};

export default meta;
type Story = StoryObj<typeof JSectionHeading>;
