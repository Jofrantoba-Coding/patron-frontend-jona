...
export type JTableColumnsConfig<TData extends Record<string, unknown> = Record<string, unknown>> =
  | JTableColumnDef<TData>[]
  | JTableColumnGroup<TData>[];
...
export const JTABLE_DEFAULTS: Required<Pick<InterJTable, 'responsiveMode'>> = {
