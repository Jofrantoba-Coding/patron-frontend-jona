...
import {
  InterTableHeadProps,
  InterJTable,
  JTablePaginationConfig,
  JTableResponsiveMode,
  JTableSortDirection,
} from './InterJTable';
import { useTableContext } from './JTableContext';
import { JTextBox } from '../../atoms/JTextBox';
import { JPanel } from '../../atoms/JPanel/JPanel';

const outerClasses: Record<JTableResponsiveMode, string> = {
...
const innerScrollClasses: Record<JTableResponsiveMode, string> = {
  scroll: 'overflow-x-auto',
  cards: '',
  none: 'overflow-x-auto',
};

export const JTableView = React.forwardRef<HTMLTableElement, InterJTable>(
...
TableCaptionView.displayName = 'JTableCaption';
...
TableHeaderView.displayName = 'JTableHeader';
...
TableBodyView.displayName = 'JTableBody';
...
TableFooterView.displayName = 'JTableFooter';
...
TableRowView.displayName = 'JTableRow';

function getNextSortDirection(current: JTableSortDirection, cycle: JTableSortDirection[]) {
  const currentIndex = cycle.indexOf(current);
  return cycle[currentIndex === -1 || currentIndex === cycle.length - 1 ? 0 : currentIndex + 1];
}

function getAriaSort(direction: JTableSortDirection) {
...
function SortIcon({ direction }: { direction: JTableSortDirection }) {
  return (
...
TableHeadView.displayName = 'JTableHead';
...
TableCellView.displayName = 'JTableCell';
