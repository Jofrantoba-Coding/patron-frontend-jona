// JCheckBoxFieldView.tsx — JONA View (render puro)
import React from 'react';
import { cn } from '../../lib/cn';
import { JCheckBox } from '../../atoms/JCheckBox';
import { JLabel } from '../../atoms/JLabel';
import { InterJCheckBoxField } from './InterJCheckBoxField';
import { JPanel } from '../../atoms/JPanel/JPanel';

export const JCheckBoxFieldView: React.FC<InterJCheckBoxField> = ({
