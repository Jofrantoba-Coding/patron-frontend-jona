...
import { JSkeletonCard, JSkeletonUserRow, JSkeletonTableRows, JSkeletonForm } from './JSkeletonPresets';
import { JButton } from '../../atoms/JButton/JButton';
import { JPanel } from '../../atoms/JPanel/JPanel';
import { JLabel } from '../../atoms/JLabel';

const meta: Meta = {
  title: 'Molecules/JSkeletonPresets',
  tags: ['autodocs'],
};
export default meta;

export const JCard: StoryObj = {
  render: () => <JPanel variant="ghost" padding="none" style={{ width: '360px' }}><JSkeletonCard /></JPanel>,
};

export const UserRow: StoryObj = {
  render: () => <JPanel variant="ghost" padding="none" style={{ width: '360px' }}><JSkeletonUserRow /></JPanel>,
};

export const TableRows: StoryObj = {
  render: () => <JPanel variant="ghost" padding="none" style={{ width: '500px' }}><JSkeletonTableRows rows={4} /></JPanel>,
};

export const Form: StoryObj = {
  render: () => <JPanel variant="ghost" padding="none" style={{ width: '360px' }}><JSkeletonForm fields={3} /></JPanel>,
};
