...
}, f = ({ name: t, email: s, size: l = "md", className: c }) => {
  const m = t.split(" ").map((o) => o[0]).join("").toUpperCase().slice(0, 2);
  return /* @__PURE__ */ a("div", { className: r("flex items-center gap-3", c), children: [
    /* @__PURE__ */ e(
      "div",
      {
        className: r("rounded-full bg-primary-600 flex items-center justify-center text-white font-semibold flex-shrink-0", n[l].avatar),
