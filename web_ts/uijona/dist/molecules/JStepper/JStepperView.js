...
const x = (i, l) => i < l ? "complete" : i === l ? "current" : "upcoming", w = () => /* @__PURE__ */ e("svg", { className: "h-4 w-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", "aria-hidden": "true", children: /* @__PURE__ */ e("path", { d: "m20 6-11 11-5-5" }) }), y = ({
  steps: i,
  activeStep: l,
  ...
  "ol",
  {
    ...
    ...b,
    children: i.map((r, a) => {
      const t = x(a, l), f = m && !r.disabled, p = n(
...
//# sourceMappingURL=JStepperView.js.map
