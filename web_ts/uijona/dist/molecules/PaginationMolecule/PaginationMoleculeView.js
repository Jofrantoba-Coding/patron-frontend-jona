...
const a = () => /* @__PURE__ */ l("svg", { className: "w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", "aria-hidden": "true", children: /* @__PURE__ */ l("polyline", { points: "15 18 9 12 15 6" }) }), y = () => /* @__PURE__ */ l("svg", { className: "w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", "aria-hidden": "true", children: /* @__PURE__ */ l("polyline", { points: "9 18 15 12 9 6" }) }), B = ({
  ...
  if (t <= 1) return null;
  const v = h(i, t, u), m = p("inline-flex items-center justify-center h-8 min-w-[2rem] px-2 rounded text-sm transition-colors duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 disabled:pointer-events-none disabled:opacity-50");
  return /* @__PURE__ */ b("nav", { "aria-label": "Pagination", className: p("flex max-w-full items-center gap-1 overflow-x-auto", f), children: [
    /* @__PURE__ */ b(
      c,
      {
        variant: "ghost",
        ...
        className: p(m, "gap-1 pr-3 text-neutral-600 hover:bg-neutral-100 border border-neutral-200"),
        children: [
          /* @__PURE__ */ l(a, {}),
    ...
    v.map((o, x) => o === "..." ? /* @__PURE__ */ l("span", { className: "shrink-0 px-2 text-neutral-400 select-none", children: "…" }, `e-${x}`) : /* @__PURE__ */ l(
      c,
      {
        ...
        className: p(m, o === i ? "bg-primary-600 text-white border border-primary-600" : "text-neutral-700 hover:bg-neutral-100 border border-neutral-200"),
        children: o
      },
      o
    )),
    /* @__PURE__ */ b(
      c,
      {
        ...
        className: p(m, "gap-1 pl-3 text-neutral-600 hover:bg-neutral-100 border border-neutral-200"),
        children: [
