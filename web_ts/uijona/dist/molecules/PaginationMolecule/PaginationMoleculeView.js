  ...
  return /* @__PURE__ */ m("nav", { "aria-label": "Pagination", className: p("flex items-center gap-1", c), children: [
    /* @__PURE__ */ m(
      "button",
      {
        ...
        className: p(b, "gap-1 pr-3 text-neutral-600 hover:bg-neutral-100 border border-neutral-200"),
        children: [
          /* @__PURE__ */ l(h, {}),
    ...
    f.map((o, x) => o === "..." ? /* @__PURE__ */ l("span", { className: "px-2 text-neutral-400 select-none", children: "…" }, `e-${x}`) : /* @__PURE__ */ l(
      "button",
      {
        type: "button",
        "aria-label": `Page ${o}`,
        ...
        className: p(b, o === i ? "bg-primary-600 text-white border border-primary-600" : "text-neutral-700 hover:bg-neutral-100 border border-neutral-200"),
        children: o
      },
      o
    )),
    /* @__PURE__ */ m(
      "button",
      {
        ...
        className: p(b, "gap-1 pl-3 text-neutral-600 hover:bg-neutral-100 border border-neutral-200"),
        children: [
