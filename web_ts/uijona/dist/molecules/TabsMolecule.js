...
import { createContext as x, useContext as d } from "react";
import { cn as i } from "../lib/cn.js";
const c = x({ value: "", onChange: () => {
}, variant: "pill", orientation: "horizontal" }), h = ({ value: e, onChange: n, onTabFocus: o, onDisabledTabClick: t, variant: r = "pill", orientation: s = "horizontal", className: u, children: a }) => /* @__PURE__ */ l(c.Provider, { value: { value: e, onChange: n ?? (() => {
  ...
  return /* @__PURE__ */ l("div", { role: "tablist", "aria-orientation": r, className: i("flex", r === "vertical" ? "flex-col" : "flex-row", t === "pill" ? "bg-neutral-100 rounded-md p-1 gap-1" : "border-b border-neutral-200 gap-0", e), ...o, children: n });
}, C = ({ value: e, className: n, children: o, disabled: t, ...r }) => {
...
}, N = ({ value: e, className: n, children: o, ...t }) => {
  const { value: r } = d(c);
...
//# sourceMappingURL=TabsMolecule.js.map
