...
import { JDATA_TABLE_DEFAULTS as N } from "./InterJDataTable.js";
import { JDataTableView as T } from "./JDataTableView.js";
function D(e) {
  const i = { ...N, ...e }, [y, g] = d(void 0), [h, S] = d(""), l = e.sort ?? y, o = e.filterValue ?? h, C = (n) => {
    var t;
    g(n.direction === null ? void 0 : n), (t = e.onSortChange) == null || t.call(e, n);
  }, w = (n) => {
    var t;
    S(n), (t = e.onFilterChange) == null || t.call(e, n);
  }, r = f(() => {
...
D.displayName = "JDataTable";
export {
  D as JDataTableImpl
};
//# sourceMappingURL=JDataTableImpl.js.map
