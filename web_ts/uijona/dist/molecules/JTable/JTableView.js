...
import { useTableContext as v } from "./JTableContext.js";
import { JPanelImpl as w } from "../../atoms/JPanel/JPanelImpl.js";
import { JTextBoxImpl as ie } from "../../atoms/JTextBox/JTextBoxImpl.js";
const le = {
  ...
  ({
    ...
    emptyMessage: p,
    ...f
  }, s) => /* @__PURE__ */ u(w, { variant: "ghost", padding: "none", radius: "none", className: c(le[t], r), children: [
  ...
  return /* @__PURE__ */ u(w, { variant: "ghost", padding: "none", radius: "none", className: "flex flex-col gap-3 border-t border-neutral-200 px-4 py-3 sm:flex-row sm:items-center sm:justify-between", children: [
    ...
    /* @__PURE__ */ u(w, { variant: "ghost", padding: "none", radius: "none", className: "flex flex-wrap items-center gap-4", children: [
      ...
      /* @__PURE__ */ u("nav", { "aria-label": "Paginacion de tabla", className: "flex items-center gap-1", children: [
        ...
        x.map(
          (l, b) => l === "ellipsis" ? /* @__PURE__ */ n("span", { className: "select-none px-1 text-neutral-400", children: "..." }, `ellipsis-${b}`) : /* @__PURE__ */ n(
            T,
            {
              active: l === s,
              "aria-label": `Pagina ${l}`,
...
const ye = d.forwardRef(
  ({
    ...
    const { columnFilters: K, setColumnFilter: V } = v(), L = d.useRef(null), [P, Q] = d.useState(""), [Z, C] = d.useState(() => F(y)), O = Z ?? F(y), I = B(O ?? y), M = h || m === "colgroup" || Number(o ?? 1) > 1, E = k && !M, z = x ?? (a !== void 0 ? K[a] ?? "" : P), { onBlur: X, className: ee, ...te } = b ?? {};
    d.useEffect(() => {
      const i = F(y);
      i !== void 0 && C(i);
    }, [y]), d.useEffect(() => {
      x !== void 0 && a !== void 0 && V(a, x);
    }, [a, x, V]);
    const re = (i) => {
      i.stopPropagation(), N == null || N(he(p, s));
    }, ae = (i) => {
      var D;
      i.preventDefault(), i.stopPropagation();
      const _ = i.clientX, ne = ((D = L.current) == null ? void 0 : D.offsetWidth) || O || J || 120, $ = (oe) => {
        const G = we(ne + oe.clientX - _, J, j);
        C(G), R == null || R(G);
      }, A = () => {
    ...
    return /* @__PURE__ */ u(
      "th",
      {
        ...
        style: {
          ...
          minWidth: B(J) ?? (t == null ? void 0 : t.minWidth),
          maxWidth: B(j) ?? (t == null ? void 0 : t.maxWidth)
        },
        "aria-sort": E ? ge(p) : H["aria-sort"],
        className: c(
              ...
              children: [
                ...
                g && /* @__PURE__ */ n(
                  ie,
                  {
                    ...
                    value: z,
                    placeholder: l,
                    "aria-label": (b == null ? void 0 : b["aria-label"]) ?? l,
                    onClick: (i) => i.stopPropagation(),
                    onChange: (i) => {
                      x === void 0 && (a !== void 0 ? V(a, i) : Q(i)), W == null || W(i);
                    },
                    onBlur: X ? (i, _) => X(_) : void 0,
                    className: c(
...
//# sourceMappingURL=JTableView.js.map
