...
import { InterJTable } from './InterJTable';
export declare const JTableImpl: React.ForwardRefExoticComponent<InterJTable & React.RefAttributes<HTMLTableElement>>;
...
export declare const TableHeadImpl: React.ForwardRefExoticComponent<import("./InterJTable").InterTableHeadProps & React.RefAttributes<HTMLTableCellElement>>;
